...
* [!DNL Analytics](#analytics) (**2019 年 8 月 12 日**&#x200B;更新)
...
* [AppMeasurement](#appm) (**2019 年 8 月 12 日更新**)
...
| 歸因 IQ 已啓用 A4T 活動曝光數和活動轉換數等度量 | 我們已為歸因 IQ 啓用兩個 Analytics for Target (A4T) 量度：活動曝光數和活動轉換數。就目前而言，Analysis Workspace 的這些量度均比 Reports &amp; Analytics 更為膨脹。經過此變更後，使用者現在可以套用「比照調整」歸因模型，使 Analysis Workspace 與 Reports &amp; Analytics 一致。 |
...
[!UICONTROL AppMeasurement] 2.16.0 版於 2019 年 8 月 15 日發行 (非先前宣布的 8 月 8 日)。
