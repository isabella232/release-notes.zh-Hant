...
| CCPA選擇退出銷售 | （6月22日發行）您現在可以使用新的CCPA選擇退出銷售區段，將CCPA選擇退出銷售請求傳達給Advertising Cloud，您可從「觀眾>區段」 [!UICONTROL 建立此區段]。 您也可以使用Advertising Cloud販賣API，從「對象」>「區段」或b)擷取客戶已提交以申請退出帳戶a)之銷售要求之ID的每月報表。  如需詳細資訊，請參 [閱https://docs.adobe.com/content/help/en/advertising-cloud/all/privacy/ad-cloud-ccpa-opt-out-of-sale.html。](https://docs.adobe.com/content/help/en/advertising-cloud/all/privacy/ad-cloud-ccpa-opt-out-of-sale.html) |
