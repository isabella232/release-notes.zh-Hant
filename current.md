...
* [Audience Manager](#aam) **( 4 月 30 日更新)**
...
如需產品文件，請參閱 [Experience Cloud 介面說明](https://docs.adobe.com/content/help/zh-Hant/core-services/interface/experience-cloud.html)。
...
>[!IMPORTANT]
>
>Adobe Analytics 在 4 月的維護發行時程皆已順延至 2020 年 5 月 21 日。如需最新的 Analytics 發行資訊，請參閱[ 3 月發行說明](c-legacy-releases/2020/03122020.md)。

* [Customer Journey Analytics](#cust-journey)
<!--* [New features in Adobe Analytics](#aa-features)-->
* [Analytics 管理員重要事項](#aa-notices) (2020 年 4 月 16 日更新)
* [AppMeasurement](#appm)
...
| 功能 | 說明 |
| -----------| ---------- |
| Data Workbench 6.74 (**2020 年 4 月 29 日更新**) | 在伺服器實作中更新身分管理服務 (IMS) TLS 憑證剖析。此更新將剖析功能從字串比對擴充至規則運算式，包括處理主旨替代名稱 (SAN) 憑證的功能。如需詳細資訊，請參閱 [Data Workbench 發行說明](https://docs.adobe.com/content/help/zh-Hant/data-workbench/using/release-notes/release-notes.translate.html)。 |
...
| 功能 | 說明 |
| -----------| ---------- |  
| [預測對象](https://docs.adobe.com/content/help/zh-Hant/audience-manager/user-guide/features/algorithmic-models/predictive-audiences/predictive-audiences.html) | [!UICONTROL 「預測對象」]可協助您使用進階資料科學技術，即時將未知對象分至不同人設。<br><br> 在行銷領域中，人設是依訪客、使用者或潛在買家來定義的對象區段，這些人有同樣的具體特徵組，例如人口統計資料、瀏覽習慣、購物歷史記錄等。<br><br>[!UICONTROL 「預測對象」]模型可讓您使用 Audience Manager 的機器學習功能，將未知對象分至不同人設，進一步運用此概念。<br><br>Audience Manager 會計算未知第一方對象對一組已知第一方對象的傾向，以達到此目的。 |
| 其他[!UICONTROL 設定檔合併規則]增強功能 | 透過[!UICONTROL 「設定檔合併規則」]，Audience Manager 客戶能根據身分而非裝置，輕鬆定義、管理及啟用對象區段。<br><br> 自 4 月 29 日起，Audience Manager 客戶能在 Audience Manager UI 中，更清楚掌握個別區段和大量報告內特徵和區段的裝置和跨裝置 ID 人口劃分。<br><br> 這可讓客戶更深入了解 Audience Manager 中的身分，進而全面掌握依裝置、個人和家庭劃分的總區段人口。跨裝置和裝置 ID 的大量特徵匯出內容也會一併更新，以反映這些增強功能。<br><br>  特定更新包括下列功能： <ul><li>彙整[「一般」](https://docs.adobe.com/content/help/zh-Hant/audience-manager/user-guide/reporting/general-reports.html)和[「趨勢」](https://docs.adobe.com/content/help/zh-Hant/audience-manager/user-guide/reporting/trend-reports.html)報表中的[跨裝置 ID](https://docs.adobe.com/content/help/zh-Hant/audience-manager/user-guide/reference/ids-in-aam.html)；</li><li>改進[「區段產生器」](https://docs.adobe.com/content/help/zh-Hant/audience-manager/user-guide/features/segments/segment-builder.html)中的[!UICONTROL 「特徵選取器」]，增加去除特徵人口的 [CRM ID](https://docs.adobe.com/content/help/zh-Hant/audience-manager/user-guide/reference/ids-in-aam.html)；</li><li>建立去除精確特徵匯出內容的[跨裝置 ID](https://docs.adobe.com/content/help/zh-Hant/audience-manager/user-guide/reference/ids-in-aam.html)；</li><li>建立去除精確特徵匯出內容的[裝置 ID](https://docs.adobe.com/content/help/zh-Hant/audience-manager/user-guide/reference/ids-in-aam.html) (應排除已驗證的特徵)；</li><li>使用 [BAAAM](https://docs.adobe.com/help/zh-Hant/audience-manager/user-guide/reference/bulk-management-tools/bulk-management-intro.html) 工具提出要求時，系統會傳回與 [CRM ID](https://docs.adobe.com/content/help/zh-Hant/audience-manager/user-guide/reference/ids-in-aam.html) 相關聯特徵的正確數量。</li></ul> |
...
| [AEM - [!DNL Magento]  透過 [!UICONTROL Commerce Integration Framework 整合]](https://www.adobe.io/apis/experiencecloud/commerce-integration-framework/getting-started.html) | 這部影片會帶您逐步了解 AEM 與 [!DNL Magento] 之間的整合設定。 |
