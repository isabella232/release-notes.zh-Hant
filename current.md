...
| 功能 | 說明 |
| -----------| ---------- |
| 統一搜尋 | 統一搜尋目前可供Experience Platform，現在支援針對Experience Platform使用者的來源和目的地搜尋。 此功能可讓您搜尋區段、資料集、結構描述、來源和目標。 |
...
| 2021 年 3 月 5 日 | [透過API擷取串流資料](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/streaming-ingestion-http-api.html) | 影片 | 此視訊示範如何使用HTTP API端點，即時串流資料至Adobe Experience Platform。 |
| 2021 年 3 月 5 日 | [使用API監控資料擷取](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/data-monitoring.html?lang=zh-Hant#data-ingestion) | 影片 | 了解如何使用平台的 UI 和 API 來監控和追蹤擷取到 Adobe Experience Platform 的資料。 |
| 2021 年 3 月 5 日 | [從資料庫中收錄資料](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-databases.html?lang=en#sources) | 影片 | 本視訊逐步說明如何以順暢且可擴充的方式，將資料從資料庫來源批次擷取至Adobe Experience Platform的即時客戶個人檔案和體驗資料湖。 |
| 2021 年 3 月 5 日 | [從AmazonS3收錄資料](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/ingest-data-from-amazon-s3.html) | 影片 | 此視訊說明如何以順暢且可擴充的方式，輕鬆將雲端儲存服務中的資料批次內嵌至Adobe Experience Platform的即時客戶個人檔案和資料湖。 |
| 2021 年 3 月 5 日 | [從Salesforce CRM擷取資料](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/ingest-data-from-salesforce-crm.html) | 影片 | 此視訊說明如何以順暢且可擴充的方式，輕鬆將CRM來源的資料批次內嵌至Adobe Experience Platform的即時客戶個人檔案和資料湖。 |
| 2021 年 3 月 5 日 | [從Adobe Analytics收錄資料](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/ingest-data-from-adobe-analytics.html) | 影片 | 「Adobe Analytics來源」連接器可讓您以順暢且可擴充的方式，輕鬆地將資料從Adobe Analytics串流至「Adobe Experience Platform即時客戶個人檔案與體驗資料湖」。 |
| 2021 年 3 月 5 日 | [瞭解來源連接器](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/overview.html?lang=en#sources) | 影片 | 此視訊提供Experience Platform來源(Sources)連接器的概觀。 |
| 2021 年 3 月 5 日 | [AdobeIO控制台導出郵件詳細資訊](https://experienceleague.adobe.com/docs/platform-learn/tutorials/apis/postman.html) | 影片 | 瞭解如何驗證及存取Experience PlatformAPI。 |
| 2021 年 3 月 5 日 | [瞭解資料擷取](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/understanding-data-ingestion.html#data-ingestion) | 影片 | 瞭解Experience Platform的資料擷取功能，讓您將資料整合到一個開放且可擴充的平台中，以管理即時客戶個人檔案。 |
...
2021年2月發行版本——在[Journey Orchestration發行說明](https://docs.adobe.com/content/help/zh-Hant/journeys/using/release-notes/release-notes.html)中進一步瞭解最新功能、改進和修正。
...
| 已發佈 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 3 月 16 日 | [更新描述檔動作](https://experienceleague.adobe.com/docs/journey-orchestration-learn/tutorials/building-a-journey/update-profile-action.html?lang=en#building-a-journey) | 影片 | 瞭解如何更新現有的Experience Platform設定檔，其中包含來自事件、資料來源或使用特定值的資訊。 |
...
## ![圖示選](/assets/experience_platform_appicon_24.png) 件決策  {#offer-decisioning}

[!UICONTROL Offer ] Designing是與Adobe Experience Platform整合的應用程式服務。使用[!UICONTROL Offer decisioning]，在適當的時間跨所有觸點為客戶提供最佳優惠和體驗。

### 最新產品發行版

2021年2月發行版——進一步瞭解[Offer decisioning發行說明](https://experienceleague.adobe.com/docs/offer-decisioning/using/new/release-notes.html?lang=en#new)中的最新功能。

### 更多Offer decisioning資源

[檔案](https://experienceleague.adobe.com/docs/offer-decisioning/using/offer-decisioning-home.html?lang=en) - [教學影片](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/overview.html?lang=en)
...
| 自訂日期範圍的Analytics儀表板支援 | 2021 年 4 月 22 日 | 記分卡建立者可以建立自定義日期範圍並將其應用於移動記分卡項目。 創作者可從熟悉的工作區和行動日期範圍預設集中選擇，或建立自訂日期範圍。 [了解更多](https://experienceleague.adobe.com/docs/analytics/analyze/mobapp/curator.html#mobapp). |
...
| Analysis Workspace:**[!UICONTROL 元件]** > **[!UICONTROL 使用者偏好設定]** | 2021 年 3 月 25 日 | [!UICONTROL 元件] > [!UICONTROL 使用者偏好設定]頁面可讓您管理使用者的[!UICONTROL Analysis Workspace]設定及其相關元件。 [!UICONTROL 使用] 者偏好套用至所有新專案和面板。<br>**注意：下** 列設定已移至「使用者 [!UICONTROL 偏好] 設定」頁：<ul><li>工作區專案：說明>啟用提示</li><li>工作區專案：空白麵板&#x200B;_使用此面板_&#x200B;選項開始新專案</li></ul> |
| Analysis Workspace:[!UICONTROL 色階分佈圖智慧型桶預測] | 2021 年 3 月 25 日 | [!UICONTROL 色階分佈圖智] 慧型儲存貯體預測功能可自動識別資料跨頁的適當區間寬度和數目，協助處理高基數量度直方圖。對於低基數量度，視覺化的運作方式與先前相同。 |
| 分析控制面板支援Customer Journey Analytics | 2021 年 3 月 25 日 | Analytics儀表板應用程式現在支援Customer Journey Analytics。 具有Customer Journey Analytics的使用者可在Analytics儀表板應用程式中，從任何已傳入Adobe Experience Platform的資料呈現KPI。 Customer Journey Analytics可讓您結合多個資料來源，以真實、多通道的方式檢視客戶體驗。 現在，有了Analytics儀表板應用程式，您隨時隨地都能獲得最新的整體業務檢視。 [了解更多](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dashboards/curator.html?lang=en#cja-dashboards). |
...
* 修正造成&#x200B;**[!UICONTROL 以人為本的目標]**&#x200B;重複區段對應驗證錯誤的問題。 (AAM-56631)
* 修正部分使用者無法存取&#x200B;**[!UICONTROL 對象報表]**&#x200B;的問題。 (AAM-57412)
* 已修補[!UICONTROL 遠端程式碼執行]弱點，攻擊者可能會利用此弱點存取敏感資料。 (AAM-57495)
...
| 已發佈 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 3 月 19 日 | [瞭解面向Audience Manager用戶的即時CDP中的資料治理](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-data-gov-for-aam-users.html) | 影片 | 瞭解[!UICONTROL 即時客戶資料平台]中的資料治理功能。 |
| 2021 年 3 月 19 日 | [品牌與消費者：](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/industry/brands-vs-consumers.html) | 影片 | 在此網路研討會中，Adobe將說明廣告商和出版商對於無Cookie未來的瞭解與準備程度、對其使用案例的影響，以及他們對更廣泛生態系統的看法。 |
| 2021 年 3 月 5 日 | [負責客戶資料管理的10項考慮事項](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/industry/ten-considerations-for-responsible-customer-data-management.html) | 事件 | 聽聽Adobe和Scotiabank Digital有關負責資料管理的主要考量。 |
| 2021 年 3 月 19 日 | [資料管理的未來與不斷變化的環境](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/industry/the-future-of-data-management-and-the-changing-environment.html) | 事件 | 在此網路研討會中，瞭解Adobe和451 Research如何思考技術和資料的未來，以因應新的行銷環境，並開始為未來的資料管理做好業務準備。 |
| 2021 年 3 月 21 日 | [在面向Audience Manager用戶的即時CDP中瞭解方案和XDM](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-schemas-xdm-for-aam-users.html?lang=en#other-integrations) | 影片 | 從Audience Manager到即時客戶資料平台（即時CDP），您將會遇到一些新概念和做法。 結構描述和XDM屬於該類別。 本影片說明這些概念。 |
| 2021 年 3 月 17 日 | [瞭解面向Audience Manager用戶的即時CDP信號](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-signals-for-aam-users.html) | 影片 | 此視訊適用於Audience Manager使用者，他們正在移轉至即時客戶資料平台（即時CDP），並討論您在Audience Manager中用來建立特性的信號（關鍵值配對）如何在Platform中使用。 |
| 2021 年 3 月 12 日 | [在面向Audience Manager用戶的即時CDP中瞭解方案和XDM](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-schemas-xdm-for-aam-users.html) | 影片 | 從Audience Manager到即時客戶資料平台（即時CDP），您將會遇到一些新概念和做法。 結構描述和XDM屬於該類別。 本影片說明這些概念。 |
...
| 2021年3月 | [Audience Manager高級技能](https://experienceleague.adobe.com/?recommended=AudienceManager-U-1-2020.5) | 課程 | 一旦您掌握了Audience Manager的基本知識，請參加本課程，瞭解如何將受眾管理提升到新的層次。 瞭解如何將人工智慧與演算法模型搭配使用、如何使用描述檔合併規則來瞭解客戶是否是人，而非裝置，以及其他絕佳主題來延伸DMP的使用。 |
...
* **AEM 6.5.8.0**
AEM 6.5 Service Pack 8 (6.5.8.0，已於 2021 年 3 月 11 日發行) 是項重要更新，其中包括自 2019 年 4 月 AEM 6.5 全面發行以來所推出的新功能、重要客戶增強功能，以及效能、穩定性和安全性等方面的改善項目。
...
* **Adobe Experience Manager 雲端服務**
   ...
   Experience Manager作為Cloud Service有什麼新意？

   * **Experience Manager網站做為Cloud Service**

      * [RemotePage元件](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/hybrid/remote-page.html?lang=en):新增支援在Experience Manager中檢視和編SPA輯外部內容。
   ...
   * **Experience Manager商務Cloud Service**
      ...
      * 發佈的CIF Venia參考網站- 2021.02.24，其中包含最新的CIF核心元件1.8.0版。如需詳細資訊，請參閱[CIF文尼亞參考網站2021.02.24](https://github.com/adobe/aem-cif-guides-venia/releases/tag/venia-2021.02.24)。
      * 已發行CIF核心元件1.8.0版。如需詳細資訊，請參閱[CIF核心元件1.8.0](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-1.8.0)。
   * **Cloud Manager**

      * 具有[IP允許清單](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/ip-allow-lists/check-ip-allow-list-status.html?lang=en#pre-existing-cdn)、[SSL證書](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/manage-ssl-certificates/check-status-ssl-certificate.html?lang=en#pre-existing-cdn)和[自定義域名](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/custom-domain-names/check-domain-name-status.html?lang=en#pre-existing-cdn)的現有自定義域名配置的客戶現在可以看到有關其先前現有配置的消息。 它們也可以透過使用者介面提供自助服務。
      * 具備必要權限的使用者現在可以編輯程式，讓他們以自助方式進行下列作業：
         * 將Sites解決方案新增至包含資產或反之的現有計畫。
         * 將網站或資產從既有的計畫中移除，同時包含網站和資產。
         * 將第二個未使用的解決方案權益新增至現有的程式，或新增為新的程式。
      * **現AEM在會針對「管線執行」和「活動」畫** 面顯 *示推播更*  ** 新標籤。
      * 如果某個環境已休眠，但也有Experience Manager更新可用，則&#x200B;**已休眠**&#x200B;狀態優先於&#x200B;**可用更新**。
      * 用戶現在可以在導航到Unified Shell的「用戶配置檔案」表徵圖（右上）後，選擇&#x200B;**查看Cloud Manager角色**&#x200B;來查看其Cloud Manager角色。
      * **申請批准**&#x200B;標籤已重新標籤至&#x200B;**生產批准**，以更清楚明瞭。
      * **版本**&#x200B;標籤已重新標籤至「生產管線」執行畫面中的&#x200B;**Git Tag**。
      * 當重要量度不符合定義的臨界值時，定義行為的標籤已重新標籤，以反映其真實行為：**取消立即**&#x200B;和&#x200B;**批准立即**。
      * 類別和方法取代清單已根據Experience Manager Cloud ServiceSDK的`2021.3.4997.20210303T022849Z-210225`版本進行更新。
      * Cloud Manager生產管道現在包含[自訂UI測試](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/test-results/functional-testing.html?lang=en#custom-ui-testing)功能。
...
* **Adobe Developers Live 2021 | 完整諮詢清單**
   ...
   [以](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-developers-live-2021-complete-session-list/m-p/394595#M27875) 下是「Experience Manager開發人員即時」中發生的所有Adobe作業 **匯總清單**。

* **2021年Adobe峰會 |完整的Experience Manager課程清單**

   [以](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-summit-2021-complete-aem-session-list/td-p/398344) 下是2021年Experience Manager首腦會議所有Adobe會議 **的匯總清單**。
...
* [Experience Manager Brand Portal 版本注意事項](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/introduction/brand-portal-release-notes.html)
...
| 已發佈 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 3 月 | [在Experience Manager Cloud Service時提供內容](https://experienceleague.adobe.com/docs/adobe-developers-live-events/events/content/feb2021/content-delivery.html#content) | 事件 | Adobe Experience Manager是Cloud Service，具備強大的預先設定內容傳送架構。 示範如何最佳化內容傳送組態 |
| 2021 年 3 月 | [將有關Forms和文檔類型的幫助文章遷移到ExL](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/pdf-forms-and-documents.html?lang=en#document-services) | 文章 | 說明不同類型的PDF forms和檔案的文章。 |
| 2021 年 3 月 | [使用AEM Publish環境進行生產部署](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/production-deployment.html#graphql) | 教學課程 | 設定本機環境，以模擬內容從「作者」例項散發至「發佈」例項。 使用GraphQL API產生React App的生產版本，此應用程式設定為使用AEM Publish環境中的內容。 在此過程中，您將學習如何有效使用環境變數，以及如何更新AEMCORS組態。 |
| 2021 年 3 月 | [使用GraphQL API進行無頭內容管理](https://experienceleague.adobe.com/?recommended=ExperienceManager-D-1-2020.1.headless) | 課程 | 探索GraphQL AEM API和無頭功能如何用來強化外部應用程式中呈現的體驗。 |
| 2021 年 3 月 | [啟動——功能視訊](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/page-authoring/launches.html) | 影片 | 在AEM Sites的發佈提供建立、製作和檢閱網站內容的方式，以供日後版本使用。 在建立產品期間，生產網站可以像平常一樣不斷改進和改變。 |
| 2021 年 3 月 | [連結關聯和取消關聯資產——功能視訊文字](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/authoring/relate-unrelate.html?lang=zh-Hant) | 影片 | 瞭解如何在中建立和管理資產之間的AEM關係。 |
| 2021 年 3 月 | [從外部應用程式向 AEM as a Cloud Service 進行驗證](https://experienceleague.adobe.com/?recommended=ExperienceManager-D-1-2020.1.aemcs) | 課程 | 瞭解外部應用程式如何使用本機開發存取Token和服務認證，以程式設計方式驗證AEM為透過HTTP的Cloud Service。 |
| 2021 年 3 月 | [在抵押申請書中填寫及簽署多個表格](https://experienceleague.adobe.com/?recommended=ExperienceManager-D-1-2020.7.forms) | 課程 | 使用AEM Forms與Sign整合，順暢地簽署檔案套件。 在表單中輸入的資料可用於在軟體包中預先填充後續表單。 |
| 2021 年 3 月 | [版本／時間彎AEM曲](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/page-authoring/timewarp-feature-video-use.html) | 影片 | 時間彎曲是Adobe Experience Manager Sites的一項功能，可讓作者快速檢視過去特定時間頁面的狀態。 |
| 2021 年 3 月 | [基礎——工作流程管理](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/workflow/use-workflow-management.html?lang=en#workflow) | 影片 | 此視訊使用「工作流程模型」來展示這組功能，但這些功能也適用於AEM啟動器。 |
| 2021 年 3 月 | [體驗片段區塊](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/experience-fragments/building-blocks.html) | 影片 | 建立區塊是體驗片段的子功能。 建立區塊可讓內容作者在不同的「體驗片段」變數中重複使用元件。 |
| 2021 年 3 月 | [工作流程編輯器](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/workflow/use-the-workflow-editor.html?lang=en#workflow) | 影片 | 工作流在Experience Manager中實現了業務流程管理，並用於自動處理內容，以及促進需要人為決策的管理和流程。 |
| 2021 年 3 月 | [AEM Assets的封閉使用者群組](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/advanced/closed-user-groups.html) | 影片 | 「封閉使用者群組」(CUG)是一種功能，可用來限制對發佈網站上特定使用者群組的內容存取。 此影片顯示「關閉的使用者群組」如何與「Adobe Experience Manager資產」搭配使用，以限制對特定資產資料夾的存取。 |
| 2021 年 3 月 | [報表](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/advanced/asset-reports.html) | 影片 | 瞭解AEM Assets如何提供企業級報告框架，以透過直覺式的使用體驗來針對大型資料庫進行擴充。 |
| 2021 年 3 月 | [智慧型影像標籤與AEM Assets](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/metadata/image-smart-tags.html) | 影片 | 影像的智慧型標籤會根AEM據影像內容自動智慧地新增中繼資料標籤至影像資產，以增強搜尋功能。 |
| 2021 年 3 月 | [中繼資料階層式、可見性](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/metadata/cascade-metadata-feature-video-use.html) | 影片 | 瞭解現場需求、可見度和情境選擇的新動態規則。 視訊還詳細說明管理員將這些規則套用至自訂中繼資料架構所需的步驟。 |
| 2021 年 3 月 | [專案主管](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/projects/use-project-masters.html?lang=en#delete-project-masters) | 影片 | 刪除主項目會導致衍生的項目無法使用。 |
| 2021 年 3 月 | [自訂頁面屬性](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/developing/page-properties-technical-video-develop.html) | 影片 | 製作有關如何最佳延伸和自訂頁面屬性的技術影片。 |
| 2021 年 3 月 | [翻譯內容片段](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/content-fragments/content-fragments-translation-feature-video-use.html) | 影片 | 瞭解內容片段如何以Adobe Experience Manager語本地化和翻譯。 與內容片段相關的混合媒體資產也符合擷取和翻譯的資格。 |
| 2021 年 3 月 | [體驗片段](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/experience-fragments/experience-fragments-feature-video-use.html) | 影片 | 瞭解Experience Fragments如何讓內容作者跨通道（包括網站頁面和協力廠商系統）重複使用內容。 |
| 2021 年 3 月 | [增強的搜尋搜尋功能](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/search-and-discovery/search-boost.html) | 影片 | 瞭解Search Boost。 |
...
| 2021 年 2 月 23 日 | [傳遞性——轉換過程- IP預熱期間的ISP特定考量](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/transition-process/isp-specific-considerations-during-ip-warming.html) | Campaign Classic/標準 | 瞭解ISP提供商查看流量時的不同規則和方式 |
| 2021 年 2 月 24 日 | [傳遞能力——第一印象——簡介](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/first-impressions/introduction.html) | Campaign Classic/標準 | 瞭解如何透過在這些領域留下良好的第一印象，為成功執行電子郵件計畫做好準備。 |
| 2021 年 2 月 24 日 | [可傳遞性——轉換程式：卷](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/transition-process/volume.html) | Campaign Classic/標準 | 瞭解傳送量如何影響電子郵件宣傳的傳遞能力。 |
| 2021 年 2 月 24 日 | [可交付性——第一印象——地址收集和清單增長](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/first-impressions/address-collection-and-list-growth.html) | Campaign Classic/標準 | 瞭解新電子郵件地址的最佳來源、如何確保高資料品質，以及符合法律准則。 |
| 2021 年 2 月 25 日 | [傳遞性——第一印象——歡迎電子郵件](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/first-impressions/welcome-emails.html) | Campaign Classic/標準 | 瞭解歡迎策略的關鍵要素。 |
| 2021 年 2 月 25 日 | [可傳遞性——轉換程式：切換電子郵件平台](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/transition-process/switching-email-platforms.html) | Campaign Classic/標準 | 瞭解如何在切換電子郵件平台時順暢地轉換。 |
| 2021 年 2 月 26 日 | [可傳遞性——內容最佳實務，以最佳傳遞性](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/content-best-practices-for-optimal-delivery.html) | Campaign Classic/標準 | 最佳化電子郵件內容以提供內容的秘訣。 |
| 2021 年 2 月 26 日 | [傳遞能力——傳送者永久性](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/sender-permanence.html) | Campaign Classic/標準 | 瞭解建立一致的傳送量為何重要。 |
| 2021 年 2 月 26 日 | [可交付性——持續監控](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/ongoing-monitoring.html) | Campaign Classic/標準 | 瞭解監控交貨時需要注意的問題。 |
| 2021 年 2 月 26 日 | [可傳遞性——付諸實踐](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/putting-it-in-practice.html) | Campaign Classic/標準 | 成功的四大關鍵支柱。 |
| 2021 年 3 月 10 日 | [為領導者、企業使用者和管理員提供最佳實務](https://experienceleague.adobe.com/?recommended=Campaign-U-1-2020.1.deliverability) | Campaign Classic | 了解傳遞能力的重要用語、概念和方法，讓您能夠確保行銷方案成功推行。 |
...
| 已發佈 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2021年3月 | [瞭解指名用戶授權](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/deploy/nameduserlicensing.html) | 文章 | 瞭解指名用戶授權的重要性。 |
| 2021 年 3 月 5 日 | [序號過期](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/deploy/cceserial.html) | 影片 | 瞭解確保您的使用者可繼續存取其Adobe應用程式和服務的必要步驟。 |
| 2021年3月 | [部署和管理登錄——支援資產](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/deploy/overview-deploy.html) | 影片 | 瞭解適用於企業的Creative Cloud如何支援自訂部署和有彈性的授權調整，以及如何與其他Adobe企業方案搭配運作。 |
| 2021 年 3 月 5 日 | [自訂Adobe Stock向量插圖中的顏色](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/customizecolors.html) | 影片 | 使用美觀的插圖，為任何專案增添光彩。 在Adobe Stock尋找完美的向量圖，然後使用Adobe Illustrator將顏色與專案的調色盤搭配。 |
| 2021 年 3 月 5 日 | [自訂Adobe Stock簡報範本，讓您看起來專業又搶眼](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/presentationtemplate.html) | 影片 | 使用Adobe Stock的影像和範本以及一些簡單易用的特效，在數分鐘內製作精美的樣式化簡報。 |
| 2021 年 3 月 5 日 | [使用Adobe Stock和](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/loadingscreen.html) | 影片 | 從Adobe Stock自訂向量圖稿，為行動應用程式建立令人毛骨悚然的載入畫面動畫。 |
| 2021 年 3 月 5 日 | [使用Adobe Stock影像建立逼真的像片構圖](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/realisticcomposite.html) | 影片 | 將兩張出色的Adobe Stock像片匯整在一起，將人們吸引到您的社交貼文中。 |
| 2021 年 3 月 5 日 | [與Adobe Stock一起快速建立激發靈感的情緒板](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/moodboard.html) | 影片 | 建立專案情緒展示板，將資訊、概念、視覺效果和顏色面板傳達給團隊／客戶。 |
| 2021 年 3 月 5 日 | [運用優美的漸層和Adobe Stock資產，建立連貫的品牌影像](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/brandgradients.html) | 影片 | 使用可編輯的向量圖形，將動畫帶入您的電子報圖片中，以供Adobe Stock使用。 |
| 2021 年 3 月 5 日 | [使用Adobe Stock和Photoshop製作電子郵件動畫](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/animationemail.html) | 影片 | 使用Adobe Stock和Photoshop的停止動作動畫，讓您的電子郵件更有效。 |
| 2021 年 3 月 5 日 | [使用Adobe Stock和](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/interactivetourismphoto.html) | 影片 | 使用Adobe Stock和Adobe的網站原型快速建立互動式像片XD。 |
