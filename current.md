...
| 共用工作區專案的專案角色 | 2020 年 6 月 18 日 | 現在共用工作區專案時，您可以根據您希望收件者擁有的專案體驗，將收件者設為下列三個專案角色：編輯、複製和檢視。[深入了解...](https://docs.adobe.com/content/help/zh-Hant/analytics/analyze/analysis-workspace/curate-share/share-projects.html) |
