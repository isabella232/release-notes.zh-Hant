...
* **實驗室 (技術預覽)：**&#x200B;這項新的 Analytics 功能可讓您在生產環境中測試新功能的原型，為 Adobe 提供有價值的意見回饋。[更多詳情...](https://docs.adobe.com/content/help/zh-Hant/analytics/analyze/tech-previews/overview.html)
...
若需修正和改善項目的相關資訊，請參閱 [Adobe Campaign Classic 發行說明](https://docs.adobe.com/content/help/zh-Hant/campaign-classic/using/release-notes/latest-release.html)。
