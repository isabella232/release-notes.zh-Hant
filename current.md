...
# 內部評論- Adobe Experience cloud發行說明- 2020年1月
...
使用您的Adobe ID，您可以根據產品、地區和事件偏好設定，訂閱狀態事件通知。

| 功能 | 說明 |
| -----------| ---------- |
| 訂閱即時電子郵件通知 | <ul><li>支援Experience Cloud、Creative Cloud、Document Cloud、AEP和Adobe服務</li><li>支援地區和事件類型偏好設定</li><li>UX支援網頁、行動裝置和平板電腦介面</li></ul> |
| 通知偏好設定管理 | <ul><li>隨時編輯和儲存通知偏好設定</li><li>隨時取消訂閱通知</li><li>項目</li></ul> |
| 個人化且更快速的電子郵件傳送 | <ul><li>當CSO和CMR開啟、更新或關閉時，會立即傳送活動通知</li><li>僅接收與您設定的偏好設定相符的相關事件通知</li><li>根據您帳戶偏好設定中設定的語言收到本地化通知</li></ul> |
| 個人化產品內通知 | 符合通知偏好設定和產品權益的事件會出現在「公告」面板中。 |
