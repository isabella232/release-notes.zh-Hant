...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 現在當使用者在 [!UICONTROL Analysis Workspace] 中開啟專案時，Analytics 使用記錄會加以追蹤 (除了現有對建立、更新、取消共用和刪除動作的追蹤以外)，讓您更清楚掌握正在使用 Workspace 的使用者以及 Workspace 的使用頻率。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Adobe 在 2018 年 6 月 不再支援 TLS 1.0 通訊協定。使用僅支援 TLS 1.0 之瀏覽器的使用者再無法再使用 Adobe [!DNL Audience Manager] 的功能。我們已為您收集瀏覽器、版本和 TLS 支援的清單。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>您現在可以從共用的 Analytics 區段建立 Google AdWords 再行銷清單 (RLSA)。過往，廣告商還必須具備 Adobe [!DNL Audience Manager]。若要符合資格，廣告商必須實作 Adobe Experience Cloud ID 服務，提供其 IMS Org ID，並在其網站上部署標籤。 </p> </td> 
  </tr> 
  <tr> 
