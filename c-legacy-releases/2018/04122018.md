...
Adobe 在 2018 年 5 月 7 日當週發行產品更新以支援[一般資料保護規範]( (GDPR)。)下列資訊可協助您瞭解和執行這些增強功能，並更新任何必要的政策和程序。
...
* 更新 Adobe Exchange URL (https://marketing.adobe.com/resources/content/resources/en/exchange/marketplace.html)，以重新導向至新的 Experience Cloud URL (https://experiencecloud.adobeexchange.com)。(CORE - 10068)
如需產品說明，請參閱 [Experience Cloud 產品文件](https://marketing.adobe.com/resources/help/zh_TW/mcloud/)。
...
* 此發行版本新增兩個 DCS 參數: ` d_tdpid` 和 ` d_tdpid_ic`。可讓您將特徵評估指定為僅限來自資料來源清單的特徵。兩個新參數的完整說明請參閱 [DCS 參考資料](https://marketing.adobe.com/resources/help/en_US/aam/dcs-keys.html)。
* 我們已更新在「個人資料合併規則」中計算跨裝置 ID 量度的方法。此量度現在可為在跨裝置策略中運用驗證方式的客戶，更準確地報告繫結至 CRM ID 的裝置總數。如需更多詳細資訊，請參閱[個人資料合併規則](https://marketing.adobe.com/resources/help/en_US/aam/profile-link-metrics.html)文件(AAM-34509)
