...
Launch 發行說明定期於以下網址更新: [https://docs.adobelaunch.com/getting-started/release-notes](https://docs.adobelaunch.com/getting-started/release-notes)。
...
[面板下拉式清單](https://marketing.adobe.com/resources/help/zh_TW/analytics/analysis-workspace/panels.html)
...
推出[自動追蹤模式](https://marketing.adobe.com/resources/help/zh_TW/analytics/advertising/aa_manual_vs_automatic_tracking.html)，Adobe Analytics 實作可自動追蹤搜尋引擎資料。

伺服器呼叫使用量增強功能

加入新的警報類型_[伺服器呼叫](https://marketing.adobe.com/resources/help/zh_TW/analytics/servercall/scu_alerts.html)_，可在伺服器呼叫使用量接近不同投入等級時提供主動通知。
...
* [Adobe.com 教學課程](https://helpx.adobe.com/tw/analytics/tutorials.html)
...
如需累積發行資訊，請參閱 [Data Workbench 發行說明](https://marketing.adobe.com/resources/help/en_US/insight/whatsnew/index.html)。
...
如需下列平台上 AppMeasurement 的版本記錄，請參閱 [AppMeasurement 版本歷史記錄](https://marketing.adobe.com/resources/help/zh_TW/sc/appmeasurement/release/index.html):
...
Adobe 於 2018 年 8 月 6 日宣佈有意終止 Ad Hoc Analysis 服務，我們將會在確定後公佈服務終止日期。如需詳細資訊，請造訪 [Discover Workspace](https://spark.adobe.com/page/S9Bhp66VJ2fEn/)。
...
* 為了將對於客戶造成的影響降至最低，我們延後了 Adobe Analytics Reporting 支援 TLS 1.0 加密技術的截止日期。自 2018 年 9 月 13 日起，**Adobe Analytics Reporting** 將不再支援 TLS (傳輸層安全性) 1.0 加密技術。我們做出此次變更，持續努力維持安全性的最高標準，並確保客戶資料安全無虞。由於 Analytics 報表介面要求使用最新的網頁瀏覽器，我們並未預見任何問題。如果您在 9 月 13 日之後無法連接至 Adobe Analytics 報表，請將瀏覽器升級為[最新版本](https://marketing.adobe.com/resources/help/zh_TW/sc/user/requirements.html)。
...
如需有關此次變更的詳細資訊，請參閱[計算量度文件](https://marketing.adobe.com/resources/help/zh_TW/analytics/calcmetrics/m_metric_type_alloc.html)。
...
Adobe Analytics Select 與 Foundation 客戶在 Workspace 中只能存取「每日精細度」[異常偵測](https://marketing.adobe.com/resources/help/zh_TW/analytics/analysis-workspace/anomaly_detection.html)功能。
...
如需移轉資訊，請參閱 [Analytics 使用者移轉至 Admin Console](https://marketing.adobe.com/resources/help/zh_TW/experience-cloud/admin-console/analytics-migration/)。
...
* 不再允許重新命名頁面。日後，您必須使用[分類](https://marketing.adobe.com/resources/help/zh_TW/reference/classifications.html)才能重新命名頁面。自 2018 年 5 月 10 日的發行版本起，系統才會繼續按照目前的設定處理重新命名的頁面。Adobe 正在要求所有客戶在當天之前移轉至分類。在 5 月的發行版本之後，將不再遵循現有的重新命名，而且會回溯變更，恕不另行通知。
...
Analytics 使用者無需再手動連結 Experience Cloud 與 Analytics 之間的帳戶。使用者可以聯絡 [Admin Console](https://helpx.adobe.com/tw/enterprise/using/admin-console.html) 的管理員以要求 Analytics 存取權。
...
如要準備好因應措施，並檢視這份受影響 API 的清單，以及了解 Adobe 的建議，請參閱 [Analytics Administration API 1.4](https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/admin-api)。
...
* 我們在 Audience Lab](https://marketing.adobe.com/resources/help/en_US/aam/audience-lab.html) 中新增了[搜尋方塊，可讓您按照名稱、說明或測試群組下的測試區段名稱來搜尋測試群組。
...
如需深入了解 Adobe Campaign，請造訪 [Adobe Digital Library](https://digitalu.adobe.com/content/Enablement/en.html)。
...
更新[與 Livefyre 整合](https://helpx.adobe.com/tw/experience-manager/6-4/sites/administering/using/livefyre.html)，加入 [Livefyre Feature Pack 2.0.6 發行版本](https://helpx.adobe.com/tw/experience-manager/6-4/release-notes/livefyre-feature-pack-206.html)的新工作流程並更新 [Feature Pack](https://helpx.adobe.com/tw/experience-manager/6-4/release-notes/feature-packs-release-notes.html) 頁面。

**Cloud Manager**

Cloud Manager 2018.6.0 自 2018 年 8 月 9 日起推出。此更新新增部署期間的發送器無效判定、額外通知以及改善易用性等支援。

如需詳細資訊，請參閱[發行說明和文件更新](https://helpx.adobe.com/tw/experience-manager/cloud-manager/using/release-notes-2018-6-0.html)。

**單一頁面應用程式**

針對 AEM SPA Editor 開發[單頁應用程式 (SPA)](https://helpx.adobe.com/tw/experience-manager/6-4/sites/developing/user-guide.html?topic=/experience-manager/6-4/sites/developing/morehelp/spa.ug.js) 的文件已更新和擴充。
...
如需深入詳細資訊，請參閱以下主題: [使用 Marketing Cloud 和 Creative Cloud 設定 AEM Assets 整合](https://helpx.adobe.com/experience-manager/6-4/sites/administering/using/configure-assets-cc-integration.html)以及[使用 Brand Portal 設定 AEM Assets 整合](https://helpx.adobe.com/experience-manager/6-4/assets/using/brand-portal-configuring-integration.html)。

**[!UICONTROL Mobile]簽署工具影像產生器**

全新的 [Mobile 簽署工具影像產生器](https://helpx.adobe.com/tw/digital-publishing-suite/help/mobile-signing-tool-image-generator.html)現已開放使用。此工具會協助您以確切的尺寸與名稱，產生 AEM [!UICONTROL Mobile] 簽署工具要求的必要影像。

**[!UICONTROL Mobile]-Android 推播通知**

已更新 [AEM Mobile 應用程式中的推播通知](https://helpx.adobe.com/tw/digital-publishing-solution/help/push-notifications.html#push-android)文件，納入 Google Firebase (Android) Console 的操作步驟。
...
請查看[近期活動行事曆](https://www.meetup.com/AEM-Technologist-Group/events/calendar/)，包含下列資源:
...
您可以購買隨選通行證，即可無限制參加超過 90 場會議。請前往[這裡](https://immerse18.adobe-devs.adobeevents.com/register/)並使用折扣碼 He7B52。
...
請查看近期會議，或前往[這裡](https://helpx.adobe.com/experience-manager/kt/eseminars/gems/aem-index.html)觀看先前錄製的會議。

**「向 AEM Community 專家提問」線上講座**

 本月網路研討會系列深入分析我們近期在 [Experience League](https://landing.adobe.com/experience-league/) | [AEM HelpX Forum](https://forums.adobe.com/community/experience-cloud/marketing-cloud/experience-manager) 探討過的多個主題。

會議於每月最後一個或倒數第二個週二，在太平洋時間 08:00/歐洲中部夏令時間 17:00 舉行。

請參閱查看近期會議，或前往[這裡](https://helpx.adobe.com/experience-manager/kt/eseminars/ask-the-expert/atace-index.html)觀看先前錄製的會議。

還是需要幫助嗎? 請前往[這裡](https://forums.adobe.com/message/9643186?cid=AEMNewCommInvite13June_MU_1)加入 AEM 社群、自我介紹並發佈問題。

與使用者同伴共襄盛舉! 我們的當地使用者團體聚會持續成長。到[這裡](https://www.meetup.com/pro/aem/)查詢您所在地區有沒有團體。沒有當地團體，想創立一個嗎? 請傳送電子郵件至 [aemusers@adobe.com](mailto:aemusers@adobe.com)
...
如需詳細資訊，請前往[這裡](https://adapt.to/2018/en/conference.html)。
