...
* 新增佈建使用者在 Activation 使用者介面內的 Auditor 卡片。(CORE-3667)
...
* DCS API: 已新增新的錯誤代碼: 198 - 來自此國家/地區的請求已被夥伴封鎖。請參閱 [DCS API 參考資料](https://marketing.adobe.com/resources/help/en_US/aam/dcs_error_codes.html)以深入了解。
