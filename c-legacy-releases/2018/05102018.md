...
<table id="table_5405964A0900476282E85E3BF9116C8B"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p><b>重要： </b>隨著GDPR於2018年5月25日生效，Adobe將實作自動刪除資料連接器( <b>先前為Genesis)合作夥伴管理之FTP帳戶中遺留的檔案。</b>(這不適用於屬於 Analytics 客戶的所有 FTP 帳戶)。目前，FTP 資料夾中的資料會無限期保留，這可能會使公司面臨未備妥 GDPR 的風險。從 2018 年 5 月 25 日開始，Adobe 將在檔案到達伺服器 30 天後，刪除 Data Connector 合作夥伴管理的 FTP 伺服器上的這些檔案。
   </p> </td> 
  </tr> 
  <tr> 
...
Adobe 在 2018 年 5 月 7 日當週發行產品更新以支援[一般資料保護規範](https://www.eugdpr.org) (GDPR)。以下資訊可協助您瞭解並實作這些增強功能，以及更新任何必要的政策和程式。
...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="uicontrol"> 行動 </span> SDK - <a href="https://marketing.adobe.com/resources/help/en_US/mobile/android/c_mob_privacy-gdpr-android.html" format="html" scope="external"> Android </a> 和 <a href="https://marketing.adobe.com/resources/help/en_US/mobile/ios/c_mob_privacy-gdpr-ios.html" format="html" scope="external"> iOS </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr.html" format="html" scope="external">  <span class="wintitle"> Audience Manager和 </span> GDPR </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/tw/campaign/kb/campaign-privacy.html" format="html" scope="external"> 促銷活動 </a> </p> </td> 
   <td colname="col2"> <p>瞭解 Adobe Campaign 為 GDPR 提供的全新功能。 </p> </td> 
  </tr> 
 </tbody> 
</table>

核心服務介面 (包括[!UICONTROL 資產]、[!UICONTROL 摘要]、[!UICONTROL 通知]、人員、[!UICONTROL Mobile] Services、Launch 及動態標籤管理) 的發行說明。也包含 Experience Cloud ID 服務發行資訊 (先前在 Analytics 中稱為&#x200B;*`Visitor ID service`*&#x200B;訪客 ID 服務和&#x200B;*`Visitor API`*&#x200B;訪客 API，以及 *`Marketing Cloud ID service`* Marketing Cloud ID 服務)。
...
<table id="table_FC7B5C6C59BD45238220D606D7BFC0A1"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>全新管理登陸頁面 </p> </td> 
   <td colname="col2"> <p>登入 Experience Cloud 並導覽至「管理」頁面時，可使用全新的直覺式介面，幫助您快速存取 Experience Cloud 解決方案和核心服務。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E08D11345DD64677B46629651A0FFDBF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>2018 年 5 月 10 日 </p> </td> 
   <td colname="col2"> <p>因為已不再支援 TLS 1.0，我們建議 Adobe <span class="uicontrol">Report Builder</span> (ARB) 使用者在 2018 年 9 月 13 日之前下載 ARB 5.6.21 版。在該日期之後，將不支援舊版ARB。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_AB20C538470D490298CEEEC586E78DFE"> 
     <li id="li_4B1B15B5CD4E48408AD180A868E4FDCF">Starting July 19, 2018, <b>Adobe Analytics Reporting</b> will no longer support TLS (Transport Layer Security) 1.0 encryption. 我們做出此次變更，持續努力維持安全性的最高標準，並確保客戶資料安全無虞。由於Analytics報表介面已需要現代化的網頁瀏覽器，因此我們預計不會發生問題。 如果您在 7 月 19 日之後無法連接至 Adobe Analytics Reporting，請將瀏覽器升級至<a href="https://marketing.adobe.com/resources/help/zh_TW/sc/user/requirements.html" format="html" scope="external">最新版本</a>。 </li> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Advertising Analytics可讓您將搜尋引擎資料從Google AdWords、Yahoo! 和Bing。 </p> <p>您可使用下列量度，對其餘的Analytics資料進行並排報告： </p> 
    ...
    </ul> <p>此外，您在Analytics中也有下列可用維度： </p> 
    <ul id="ul_D92898E28FEB4ADAB68869B3276182A9"> 
     <li id="li_B75433D55E0246C1AF2C86FDC830193A">關鍵字元合類型(AMO ID) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Analytics Connector是Power BI案頭體驗中的原生資料連接器。 啟動時，您可以使用現有的Adobe ID進行驗證。 然後，您就可以存取簡單好用的報表套裝資料元素導覽器，並建立資料請求。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>內容感知會話可讓行動分析人員和產品經理定義他們希望回溯處理行動應用程式瀏覽的方式。 它新增了在瀏覽以外處理背景點擊，以及在應用程式啟動時開始瀏覽的功能。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>報告：變更訪客郵遞區號維度 </p> </td> 
   <td colname="col2"> <p>我們已更新「訪客郵遞區號」維度，使其與其他地理變數一致，如此點擊的第一個值就會收到該點擊的評分。 </p> <p>例如，如果您執行「城市」報表並依「訪客郵遞區號」加以劃分，則劃分中只會顯示每個點擊的第一個值。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>分類的變更 </p> </td> 
   <td colname="col2"> <p>分類UI已更新，以結束對數值和資料啟用分類類型的支援。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Analytics 的資料管理標籤 UI 變更如下: </p> 
    <ul id="ul_67929C32C8064D428216173D06C449BA"> 
     ...
     <li id="li_B6663A0FACA644A3AF11606892186CDC">只有在事件中出現特定<span class="uicontrol">「ID-DEVICE」</span>時，以標籤標示為<span class="uicontrol">「DEL-DEVICE」</span>的欄位值才會進行匿名處理。這些值的其他例項（發生在未刪除的事件中）將不會變更。 因此，計算欄位獨特計數的報表可能會變更。 在共用裝置上，除了資料主體以外，其他個人的識別碼可以移除。 </li> 
     <li id="li_3E30CF2F973B46229D3726FC2320868B">已移除<span class="uicontrol">「請勿刪除」</span>標籤。 </li> 
     <li id="li_BCB7DF19FA81459E9BE598B19C956460">新增將變數上的「資料管理」標籤匯出至。csv檔案的功能。 這可協助您與法律團隊共用標籤。 </li> 
     <li id="li_CF202A81A675463BA3BC6783D9C9E0A1">新增維度的範例值，可讓您更輕鬆地查看每個變數包含的資料類型，以及應如何標示。 </li> 
    </ul> <p>此外， </p> 
  ...
  <tr> 
   <td colname="col1"> <p>臨機分析中的國家報表 </p> </td> 
   <td colname="col2"> <p>臨機分析中的「國家」報表已重新命名為「國家／地區」。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Video Analytics </p> </td> 
   <td colname="col2"> <p> <b>媒體收集 API </b> </p> <p> 由於VA SDK限制或缺乏視訊分析(VA)SDK支援，無法完全測量其視訊檢視的媒體發佈者，可將Media Collection API套用至這些裝置。 這可讓用戶端對使用者觀看視訊的所有裝置保持透明，包括VR頭戴式裝置、遊戲主機等裝置。 Media Collection API可透過您的心率VA SDK收集，提供精細、標準化的量度。 現在，您可以結合這些量度，以檢視完整的客戶歷程。 </p> 
    <ul id="ul_FD2036F9D160400AAB654CEE30657AAB"> 
     <li id="li_5F4D87F536F6436DAD99F6CDB878BD52">在任何裝置上測量視訊：將Media Collection API套用至目前不支援SDK的任何裝置，包括遊戲主機和VR裝置。 </li> 
     <li id="li_2DEE2FE8ED26476CA4C25163D4803345">RESTful API可補充VA SDK:Media Collection API的建立目的，是提供簡化、有效率的測量機制，以透過SDK取得相同的精細結果和度量。 </li> 
     <li id="li_F4D509A6904C484AA1F0BDFAEA678F8A">整體受眾評估：Media Collection API現在可提供所有客戶參與影片的完整檢視，以更精確地洞察您的完整客戶觸及面。 </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_A50A05631E574C83AD7075579B14ACF1"> 
      <li id="li_227327CC9233438688BF7F593027C1DE">修正從 [!UICONTROL Analysis Workspace] 開啟「計算量度產生器」時發生的問題。這會導致「函式」下拉式清單不顯示任何選項。 (AN-160698) </li> 
      <li id="li_C24CD6D3CDF748A0B959D44A4DF41C6A">修正自由表格中「搜尋」功能的多個問題。 結果是，基本和進階篩選查詢的編輯體驗已改善。 (AN-159843) </li> 
      <li id="li_727C26115CF946CDA62982DBEA4EAC6B">修正如果文字元合現有標籤，則無法建立標籤的問題。 (AN-159363) </li> 
      <li id="li_DCFFC6CB25054530B5B8B0418DB5CC36">修正文字視覺化預設至頁面頂端，且無法置於所需位置的問題。 (AN-159148) </li> 
      <li id="li_ABD6A21F42664A3EAEE0036388831B8B">修正在自由表格的「搜尋」欄位中，日文和韓文字元輸入問題。 (AN-158778) </li> 
      <li id="li_A4F55515A9CA4845A4662DEA5712EE77">修正當非管理員偏好、套用標籤至或核准專案時，專案修改日期變更的問題。 (AN-157398) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_666BB742E5BE4CC9BE95E697DA5DBB67"> 
      <li id="li_6B5F531B822D4392AD7760752C29B371">修正「區段產生器」中，「序列前僅限」和「序列後僅限」選項上的標籤已切換並已復原的問題。 (AN-160747) </li> 
      <li id="li_ED686B21894E4309841C7E322BB35843">修正非管理員使用者擁有某些報表套裝工具存取權的問題。 (AN-159451) </li> 
      ...
      <li id="li_7AF0C1DF79844130B488EDAF27A35B91">修正「公司設定」下的密碼過期功能問題。 (AN-154927) </li> 
      <li id="li_07E8FF50269B4B7B82EBE67BBF0335A3">修正當資產要轉移的使用者列為警報擁有者時，「轉移資產」功能無法運作的問題。 (AN-160747) </li> 
      <li id="li_E2A3A073962847FE98D3866E97B6EF04">修正透過Experience Cloud登入Analytics時發生的問題：當多個登入公司與使用者名稱相關聯時，有時會選取不正確的登入公司。 (AN-160880) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_EB8261E817054C2F8B17C09D16DB3412"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>網站服務報表API </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>我們已發佈 DIL 7.0 版本，其中包括下列升級和修正項目: </p> <p> 
     <ul id="ul_D127326A5EA14C028D43A62CAA8CD758"> 
      ...
      <li id="li_53DBDB6DAB354DF1AD8545A9F14D36F5">實作DIL Launch擴充功能的UX審核。 (CORE - 8143)
 </li> 
     </ul> </p> <p>如需最新版本，請聯絡 Adobe 顧問或客戶服務，或從 <a href="https://marketing.adobe.com/resources/help/zh_TW/dtm/c_overview.html" format="https" scope="external">Digital Tag Management (DTM)</a> 或 <a href="https://marketing.adobe.com/resources/help/en_US/experience-cloud/launch/t_quick-start.html" format="https" scope="external">Adobe Launch</a> 取得。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>As we approach the May 25th, 2018 date at which the European General Data Protection Regulation (GDPR) comes into law, we have prepared documentation to assist you in managing consumer data in  <span class="wintitle"> Audience Manager </span> to meet GDPR obligations. 請參閱: </p> <p> 
     <ul id="ul_542C0E9F27804307AED8FCE933135A43"> 
      <li id="li_853306663308434CAF8F63EFC7895817"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr-details.html" format="https" scope="external"> Audience Manager中的GDPR </a> </p> </li> 
...
* 修正客戶無法透過API呼叫擷取所有特徵清單的錯誤。 (AAM-36824)

* 修正「區段產生器 [](https://marketing.adobe.com/resources/help/en_US/aam/c_segment_builder.html) 」程式碼檢視中，如果客戶再次編輯區段，包含括弧的運算式會放置括弧的錯誤。 (AAM-36393)
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>AEM Smart自訂標籤2.1 </p> </td> 
   <td colname="col3"> <p>最新的增強智慧型標籤版本提供主要改良功能，例如： </p> <p> 
     <ul id="ul_1F32257EF31548F986B7D547056BDB3C"> 
      <li id="li_4EDD96DF180B436CB817B8E1B150F1DF">演算法最佳化可進一步提高模型精度、召回值。 </li> 
      <li id="li_86039BFA4E2E4B16A24F44A2FF710431"> 支援重設租用戶層級所有標籤的模型訓練。 </li> 
      <li id="li_7363B9318FB1492A9F067B7F534C5355">支援增強的智慧標籤命名空間以避免衝突。 </li> 
      <li id="li_9A675C8D29B549ADAE15BBC1B81311A7">新的模型更換政策可避免因再培訓而降級。 </li> 
      <li id="li_956259E154DC43DDAFE59836511AF87E">監控每位租用戶的服務使用情況。 </li> 
      <li id="li_352CE4CD51AC4F798B11F6C2C0E9090C">叢集、連線特定問題已解決，以改善服務的穩健性。 </li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>歐盟有關資料隱私權的GDPR（通用資料保護規則）將於2018年5月生效。 深入瞭解 AEM 和 <a href="https://helpx.adobe.com/experience-manager/6-4/managing/using/gdpr-compliance.html" format="https" scope="external">GDPR 法規遵循事項</a>。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>年度虛擬全球會議為企業開發人員、建築師和資料科學家提供深入的研討會，讓他們在所有體驗層級上都能參與。 在印度標準、英國夏令時區和太平洋時區舉辦即時會議。 持票人也可在一年內無限存取所有錄制內容。 </p> <p>Adobe IMMERSE是年度虛擬全球會議，適合在Adobe Experience Manager上建立解決方案的開發人員。 我們今年還會舉辦其他有關Adobe Cloud Platform、Adobe I/O、Adobe Sensei、ColdFusion和FrameMaker的課程。 </p> <p>從Adobe及更廣大的開發人員社群的專家那裡取得深入的產品介紹、「如何」方式、最佳實務和程式碼範例。 即時會話將在三個時區間進行廣播： </p> <p> 
     <ul id="ul_BDA2A6B569EF422B9327FBF7474D7D98"> 
      <li id="li_69F4FDE29DE14B1A969F428CB3A1A5A6">美洲（太平洋標準時間） </li> 
      <li id="li_E3EA932CAA4F4122ACC7982CA1856CD1">歐洲（英國夏令時） </li> 
      <li id="li_673F096F6C7541FB8F3FAA21914852F7">亞太地區（印度標準時間） </li> 
     </ul> </p> <p>歡迎參考大會議程，並請踴躍註冊 (使用折扣碼 <b>MR765z</b> 立即折抵 25.00 美元)，註冊網址如下: <a href="https://adobe.ly/immerse18" format="https" scope="external">https://adobe.ly/immerse18</a>。請勿錯過Adobe主持的大型開發人員會議！ </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>AEM Technologist Meetup Group </p> </td> 
   <td colname="col3"> <p>此虛擬群組會提供AEM GEM的通知，讓您在排程時立即向AEM社群專家諮詢。 您也會收到會面活動和區域使用者群組聚會的通知。 </p> <p> 透過以下網址加入: <a href="https://adobe.ly/2sVoSwy" format="https" scope="external">https://adobe.ly/2sVoSwy </a> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> </p> </td> 
   <td colname="col2"> <p>文字廣告和購物廣告範本中的動態消息篩選 <i>器現在包含</i><i>不在、小於</i>、 <i>大於的運算子</i>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> </p> </td> 
   <td colname="col2"> <p>文字廣告和購物廣告範本中的舊版標籤值現在為唯讀。 </p> <p>當舊版限制標籤和純標籤在未來數週內移轉至新的標籤分類結構時，現有標籤將會自動換成對應的標籤分類值和限制值 (若適用)。不過，如果您的範本所含標籤，使用來自未對應至標籤分類之摘要檔案、修飾字元或舊版標籤的動態值，該值就不會自動新增到「標籤分類」索引標籤。帳戶管理員通知您舊版標籤已完成移轉後，請查看「標籤分類」索引標籤所顯示的值，必要時請加以編輯。動態值可繼續運作，直到舊版標籤基礎結構停用為止。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> </p> </td> 
