...
* 修正使用者透過存取 [!DNL  marketing.adobe.com][!DNL  experiencecloud.adobe.com][!DNL  http] 而非 [!DNL  https] (安全)存取時的問題。(CORE - 15587)
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>歸因 IQ 可讓您針對行銷績效執行更精細的智慧化分析作業。全新的歸因模式適用於 [!UICONTROL Analysis Workspace] (任何表格或任何劃分) 與計算量度中的量度。全新的歸因面板可提供更理想的視覺化效果和比較功能。 </p> <p>由於 IQ 現在已提供給 Ultimate、Prime、Select 和 Foundation SKU 的客戶使用 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>針對 [!UICONTROL Analysis Workspace] 的日期範圍預設集新增「過去 13 週整」。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>我們新增了啟用/停用 Experience Cloud 區段共用的新權限。現在，您可以從 <a href="https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_build.html" format="html" scope="external">Analytics Segment Builder</a> 中移除 Experience Cloud 區段共用的存取權限。該權限稱為「區段發佈」。預設為已啟用。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
...
<table id="table_E08D11345DD64677B46629651A0FFDBF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>因為已不再支援 TLS 1.0，我們建議 Adobe [!UICONTROL Report Builder] (ARB) 使用者在 2018 年 9 月 13 日之前下載 ARB 5.6.21 版。<b>在當天以後，舊版的 ARB 將無法繼續運作</b>。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Audience Optimization for Publishers 可針對您擁有且運作之內容，協助您鑑別 [!DNL Audience Manager] 區段的效能潛力。這些報表將記錄層級行銷活動的效益資料結合 [!DNL Audience Manager] 量度，找出將對象最佳化及獲利的機會。 </p> <p>預設不會提供這些報告。如要開始使用，請聯絡您的 [!DNL Audience Manager] 顧問或客戶服務人員。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/import-dfp.html" format="https" scope="external"> 將DFP資料檔案匯入[！DNL Audience Manager] </a> </p> </td> 
   <td colname="col2"> <p>在 [!DNL Audience Manager] 可啟用 Audience Optimization for Publishers 之前，請務必確認您已符合本文所述的所有必要條件。確認符合所有必要條件之後，請聯絡客戶服務人員。 </p> </td> 
  </tr> 
 </tbody> 
</table>
