...
重要須知: 請將您安裝的 [Report Builder](https://marketing.adobe.com/resources/help/zh_TW/arb/t_install_arb.html) 更新至最新版本。自 2018 年 4 月起，必須安裝此項更新才能將 Analytics 使用者 ID 移轉至 Admin Console。
...
| 功能 | 說明 |
|--- |--- |
| [即時跨裝置隱藏](https://marketing.adobe.com/resources/help/en_US/aam/instant-cross-device-suppression.html) | 即時跨裝置隱藏功能可以在任一裝置出現特殊狀況時，在多個裝置上隱藏連接到這些裝置的使用者。使用即時跨裝置隱藏功能可以為使用者提供跨裝置的一致體驗。透過 [!DNL Audience Manager] 的即時不分區功能便能提供一致的體驗。 |
...
請參閱[發行說明](https://helpx.adobe.com/tw/experience-manager/cloud-manager/using/release-notes-2018-50.html)。

**核心元件第 2.1.0 版**

[核心元件](https://helpx.adobe.com/experience-manager/core-components/user-guide.html)的發行版本 2.1.0 現已推出，引入[影像](https://helpx.adobe.com/experience-manager/core-components/using/image.html)元件改良、全新的[預告](https://helpx.adobe.com/experience-manager/core-components/using/teaser.html)元件和多個錯誤修正。
...
您可以購買隨選票券，即可無限制存取 90 多場個會議。請前往[這裡](https://immerse18.adobe-devs.adobeevents.com/register/)並使用折扣碼 He7B52。
...
請查看近期會議，或前往[這裡](https://helpx.adobe.com/experience-manager/kt/eseminars/gems/aem-index.html)觀看過去錄製的會議。
...
請查看近期會議，或前往[這裡](https://helpx.adobe.com/experience-manager/kt/eseminars/ask-the-expert/atace-index.html)觀看過去錄製的會議。
...
如需詳細資訊，請前往[這裡](https://evolve.3sharecorp.com/)。
...
 請前往[這裡](https://www.meetup.com/pro/aem/)尋找當地使用者團體聚會。如果您找不到當地使用者團體，而您有興趣組建新的團體，請傳送電子郵件至 [aemusers@adobe.com](mailto:aemusers@adobe.com)
...
按一下任何頁面上方的協助圖示 ([!UICONTROL ?**]**) 即可取得 Advertising Cloud 的說明。
