...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>「自動最佳化出價調整」選項可讓Advertising cloud在投資組合最佳化時自動變更投資組合中廣告群組的出價調整設定，以最佳化效能。 Advertising cloud可以最佳化Google、Bing和Yahoo！的出價調整 Yahoo! Japan 行動裝置目標；Google 與 Bing 平板及電腦目標；Google RLSA 目標與 Google 位置目標。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Bing 商家中心帳戶與最終 URL)「追蹤範本」欄位可用於 Bing 購物範本及批量表單中的產品群組。 </p> <p>若是Advertising cloud轉換追蹤，如果您在帳戶、促銷活動或廣告群組層級有追蹤範本，則不需要輸入值。 </p> </td> 
  </tr> 
  <tr> 
