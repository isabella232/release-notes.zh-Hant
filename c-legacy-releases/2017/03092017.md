...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>「自動最佳化出價調整」選項可讓Advertising Cloud在最佳化作品集時，自動變更作品集中廣告群組的出價調整設定，以最佳化效能。Advertising Cloud可最佳化Google、Bing和Yahoo！Yahoo! Japan 行動裝置目標；Google 與 Bing 平板及電腦目標；Google RLSA 目標與 Google 位置目標。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Bing 商家中心帳戶與最終 URL)「追蹤範本」欄位可用於 Bing 購物範本及批量表單中的產品群組。 </p> <p>對於Advertising Cloud轉換追蹤，如果您在帳戶、促銷活動或廣告群組層級有追蹤範本，則無須輸入值。 </p> </td> 
  </tr> 
  <tr> 
