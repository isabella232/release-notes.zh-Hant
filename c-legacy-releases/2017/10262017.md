...
* 您可以透過 GET 或 POST 方法使用我們的 DCS API。[DCS API 方法](https://marketing.adobe.com/resources/help/en_US/aam/dcs-api-methods.html)說明每個案例中必須使用的語法。
...
如需產品文件，請前往 [Adobe Campaign Standard 文件](https://docs.adobe.com/docs/en/campaign/ACS.html)。
