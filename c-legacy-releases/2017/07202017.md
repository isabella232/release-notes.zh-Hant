...
如需 [SDK檔案，請參閱Marketing Cloud解決方案適用的Android SDK 4.x和](https://marketing.adobe.com/resources/help/zh_TW/mobile/android/) Marketing Cloud解決方案適用的iOS SDK 4.x [](https://marketing.adobe.com/resources/help/zh_TW/mobile/ios/) 。 若要參閱先前版本的發行說明，請展開左側面板的&#x200B;*先前發行說明*。
