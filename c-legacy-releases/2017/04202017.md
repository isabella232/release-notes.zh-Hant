...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>從Advertising Cloud提供反向資料饋送的新版本，大幅提升了資料的精確性。所有使用 Analytics 整合功能的廣告商將在皆下來幾週升級為新反向饋送。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>您現在可以使用現有 Adobe Experience Cloud 對象的電子郵件清單或區段，建立 Google 對象 (搜尋廣告的再行銷名單): </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Adobe Audience Manager細分：(僅適用於列入白名單的廣告商)「促銷活動測試版」與「amp」；gt；受眾與受眾；gt；觀眾，您可以從任何具有Advertising Cloud作為目的地的Audience Manager區段建立Google網站標記式對象。這可包含發佈至 Adobe Experience Cloud 的 Adobe Analytics 區段，以及使用「人」核心服務，在 Adobe Experience Cloud 中建立的區段。Advertising Cloud會自動將Google追蹤URL推送回Audience Manager區段，以便Google追蹤觀眾。 </li> 
     </ul> </p> <p>Advertising Cloud不會儲存您的電子郵件清單或Audience Manager區段中用來建立或編輯Google觀眾的客戶資料。 </p> </td> 
  </tr> 
  <tr> 
