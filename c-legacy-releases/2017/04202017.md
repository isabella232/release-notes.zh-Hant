...
<table id="table_7888822703184513A437A3CEFC599CAA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 在分析工作區中，您可以套用「人員」量度，以識別其裝置上的訪客。 </p> <p>在 <a href="https://marketing.adobe.com/resources/help/zh_TW/mcdc/mcdc-people.html" format="html" scope="external">Adobe Marketing Cloud Device Co-op</a> 文件中，了解如何使用「人員」量度。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>人員模板 </p> </td> 
   <td colname="col2"> <p>注意:「人物」範本與相關的「人物」量度僅在作為 <a href="https://marketing.adobe.com/resources/help/zh_TW/mcdc/mcdc-people.html" format="html" scope="external">Adobe Marketing Cloud Device Co-op</a> 的一部分時才可供使用。 </p> <p>此模板是根據「人物」量度建立，該量度是「不重複訪客」量度消除重複項後的版本。「人物」量度提供的是客戶利用多部裝置與品牌互動的頻率。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
...
* 我們改進了描述檔連結功能。 The feature now links an [Audience Manager UUID](https://marketing.adobe.com/resources/help/en_US/aam/ids-in-aam.html) to another three Audience Manager UUIDs, for a total of 4 Audience Manager UUIDs in a cluster. (AAM-28808)
...
* 區段 API 方法已移轉至 Swagger。See [Audience Manager API Code Migration](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AAM-28601)

* 已移除DAID目的地的「可定址對象」中的幾個小視覺錯誤。 (AAM-28679)

* 修正「使用者管理」頁面中，當客戶嘗試為公司建立使用者名稱且已使用的使用者名稱時，未顯示錯誤訊息的問題。 (AAM-28945)

* 已修正在密碼重設模式、Audience Marketplace和在使用者介面上排序清單頁面的欄中顯示錯誤圖示的視覺錯誤。 (AAM-28953)

* 修正Audience Manager管理介面中，無法將Audience Marketplace使用者ID新增至公司的問題。 (AAM-28953)
...
Adobe已發佈 [Windows與Linux專用Adobe Campaign](https://helpx.adobe.com/security/products/campaign/apsb17-09.html) 6.11版的安全性公告。
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>您現在可以存取Creative SDK所提供的完整功能集，以在編輯電子郵件或登陸頁面時，直接在內容編輯器中增強您的影像。 </p> <p> 這項功能不需要購買其他Creative Cloud解決方案。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> 交易式推播通知 </p> </td> 
   <td colname="col2"> <p> 行動應用程式通道已新增至Adobe Campaign的交易訊息功能。 交易式訊息現在支援三個通道：電子郵件、簡訊和推播通知。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>下列位置提供最新建議的AEM Oak Cumulative Fix Pack: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> 美加山區標準時間 2017 年 4 月 25 日上午 09:00 至 10:00，加入 2015 至 2016 年社群成員 AEM 社群進階使用者 Lokesh BS，討論「在 Experience Manager 中使用 Bootstrap 與 Angular JS 建立回應式配置」。 </p> <p>您將會學習AEM開發技巧，以便套用至AEM專案。 Lokesh將提供示範並回答您的問題。 身為AEM開發人員，這是您不想錯過的工作階段。 您可以在<a href="https://communities.adobe.com/content/usergenerated/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/_jcr_content/par/calendar/ask_the_aem_communit_7.form.html/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/upcoming-event-detail" format="https" scope="external">這裡回覆</a>。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>從Advertising Cloud到Analytics的新版反向資料饋送可大幅改善資料準確性。 具有Analytics整合的所有廣告商將在未來數週內升級為新的反向動態消息。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>您現在可以使用電子郵件清單或現有Adobe Experience Cloud觀眾的區段來建立Google觀眾（搜尋廣告的再行銷清單）: </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Adobe Audience Manager細分：（僅限允許列出的廣告商的測試版）來自促銷活動測試版&amp;gt;觀眾&amp;gt;觀眾，您可以從任何以Advertising Cloud為目的地的Audience Manager區段建立Google網站標籤式觀眾。 這可能包括發佈至Adobe Experience Cloud的Adobe Analytics區段，以及使用People核心服務在Adobe Experience Cloud中建立的區段。 Advertising Cloud會自動將Google追蹤URL推回Audience Manager區段，讓Google可以追蹤觀眾。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>（僅限測試版允許列出廣告商）新的「搜尋測試版」使用者介面將於發行後的一週提供，其中包含： </p> <p> 
     <ul id="ul_4D73AB12C2524DD4B0D72AFF1EC5FC0B"> 
      ...
      <li id="li_649DA70ACC7A4A46B2EF91C9C028DE26">「對象」選單，包含「資料庫」、「目標」和「排除」。 「資料庫」會列出您的所有Google對象（再行銷清單），而且您可以使用Adobe Audience Manager的區段來建立Google對象。 您可以將Google促銷活動中的任何對象當做廣告群組層級定位、促銷活動和廣告群組層級排除。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
