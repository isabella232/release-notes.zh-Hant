...
* 區段 API 方法已移轉至 Swagger。請參 [閱Audience Manager API程式碼移轉](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html)。 (AAM-28601)
  ...
  <tr> 
   ...
   <td colname="col2"> <p>您現在可以使用電子郵件清單或現有Adobe Experience Cloud觀眾的區段來建立Google觀眾（搜尋廣告的再行銷清單）: </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Adobe Audience Manager細分： （僅允許廣告商的測試版）From Campaigns Beta &amp;gt; 觀眾&amp;gt; 觀眾，您可以從任何以Advertising Cloud為目的地的Audience Manager區段建立Google網站標籤式觀眾。 這可能包括發佈至Adobe Experience Cloud的Adobe Analytics區段，以及使用People核心服務在Adobe Experience Cloud中建立的區段。 Advertising Cloud會自動將Google追蹤URL推回Audience Manager區段，讓Google可以追蹤觀眾。 </li> 
     </ul> </p> <p>Advertising Cloud不會儲存您電子郵件清單或Audience Manager區段中用於建立或編輯Google觀眾的任何客戶資料。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>搜尋行銷活動 (測試版) </p> </td> 
   <td colname="col2"> <p>（僅限廣告商的測試版）新的「搜尋測試版」使用者介面將於發行後的一週提供，其中包含： </p> <p> 
     <ul id="ul_4D73AB12C2524DD4B0D72AFF1EC5FC0B"> 
      ...
      <li id="li_649DA70ACC7A4A46B2EF91C9C028DE26">「對象」選單，包含「資料庫」、「目標」和「排除」。 「資料庫」會列出您的所有Google對象（再行銷清單），而您可以使用Adobe Audience Manager的區段來建立Google對象。 您可以將Google促銷活動中的任何對象當做廣告群組層級定位、促銷活動和廣告群組層級排除。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
