...
<table id="table_39E9A53B4A1A465589547638A29CB34C"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> (Bing Ads促銷活動含有重新行銷目標) Advertising Cloud支援以下各項： </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在AdWords對象目標報表中，您現在可以包含Advertising Cloud追蹤之交易屬性的欄。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bing Ads將於月25日開始將Advertising Cloud管理帳戶移轉至新的網站連結模型(共用網站連結)；程序預計需要天。月22日到完成帳戶移轉後，Advertising Cloud將無法存取網站連結，且會顯示為已刪除。如果您需要在移轉完成之前變更網站連結，請直接在Bing Ads編輯器中工作；您的變更將會移轉至新模型，並在移轉完成後由Advertising Cloud同步。支援共用網站連結的功能將在 10 月的發行中提供。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>搜尋行銷活動 (測試版) </p> </td> 
