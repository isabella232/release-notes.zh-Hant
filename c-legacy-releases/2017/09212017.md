...
* 新增全新文件、[內容安全性原則及 Marketing Cloud ID 服務](https://docs.adobe.com/content/help/en/id-service/using/reference/csp.html)，說明如何將 ID 服務使用的 Adobe 網域呼叫加入白名單。
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 使用可操作的記錄檔，您即可擷取 Google DCM 記錄的媒體資料，並在 Audience Manager 中使用此資料做為特徵。從廣告伺服器擷取曝光數、點按數及轉換數做為特徵，而不必使用像素呼叫。請參閱<a href="https://marketing.adobe.com/resources/help/en_US/aam/actionable-log-files.html" format="https" scope="external">可操作的記錄檔</a>。 </p> </td> 
  </tr> 
  <tr> 
...
* 修正導致 [Audience Lab](https://marketing.adobe.com/resources/help/en_US/aam/audience-lab.html) 無法及時載入的錯誤。(AAM-32249)
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bing ads將於9月25日開始將Advertising cloud管理的帳戶移轉至新的網站連結模型（共用網站連結）;預計整個過程需要4天。 在9月22日到帳戶移轉完成之間，Advertising cloud將無法存取網站連結，且網站連結會錯誤地顯示為已刪除。 如果您需要在移轉完成前變更網站連結，請直接在Bing ads編輯器中工作；您的變更將移轉至新模型，並在移轉完成後由Advertising cloud同步。 支援共用網站連結的功能將在 10 月的發行中提供。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>搜尋行銷活動 (測試版) </p> </td> 
