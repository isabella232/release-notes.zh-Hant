...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>可操作的日誌檔案 </p> </td> 
...
<table id="table_0225913B8D5D4B52982ED2E7F2095EEE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>利用Federated Data Access連接器（現在也支援SAP HANA），打破隔閡，‪在‪Adobe Campaign中即時運用所有外部資料‪。 Federated ‪ Data Access‪可讓使用者將多個不同的‪外部‪資料庫連結至Adobe Campaign。 從任何來源即時查詢資料，而‪不需匯‪入資料集或將資料儲存在Adobe Campaign平台中。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p>現在，當作品集使用「自動調整促銷活動預算限制」選項時，「因預算而遺失印象分享」的Google資料會用於自動調整作品集中的促銷活動預算。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>現在所有使用者都可以在「搜尋廣告 &amp;gt; 行銷活動 &amp;gt; 行銷活動 (測試版)」找到新的搜尋測試版使用者介面。 </p> <p>新功能包括： </p> <p> 
     <ul id="ul_F43F02DBCF9A4248AC7A7258FB13ECC7"> 
      ...
      <li id="li_582AF532BBCA479DB57CDA4BCD88BA1A">現在，除「廣告」和「網站連結」檢視外，所有檢視都在工具列中有搜尋功能。 </li> 
