 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>之前，資料摘要管理員必須仰賴 Adobe 客戶服務來取得其資料摘要作業的狀態更新或變更其資料摘要。資料摘要使用者介面現已可供所有 Adobe Analytics 管理員使用。 </p> <p>使用 Analytics 資料摘要介面可: </p> <p> 
     ...
     </ul> </p> <p>資料摘要服務名稱已變更，<span class="term">點按流資料饋送</span>重新命名為 <span class="term">Analytics 資料饋送</span>。 </p> <p>如需詳細資訊，請參閱 <a href="https://marketing.adobe.com/resources/help/en_US/reference/analytics-data-feed.html" format="https" scope="external">Analytics 資料摘要</a>。 </p> </td> 
  </tr> 
  <tr> 
