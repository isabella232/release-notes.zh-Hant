...
[搭配不同 Marketing Cloud 解決方案和服務使用 DNS 預先擷取](https://marketing.adobe.com/resources/help/zh_TW/mcloud/dns-prefetch.html)
...
* 更新 Venn 圖以說明 Addressable Audience 條款。請參閱[可定址對象文件](https://marketing.adobe.com/resources/help/en_US/aam/addressable-audiences.html)。(AAM-27559)

* 在輸出資料檔案中新增新的 &lt;DPUUIDS&gt; 內容巨集。請參閱[傳出範本巨集](https://marketing.adobe.com/resources/help/en_US/aam/outbound-template-macros.html)和[傳出巨集範例](https://marketing.adobe.com/resources/help/en_US/aam/outbound-macro-examples.html)。(AAM-28000)
