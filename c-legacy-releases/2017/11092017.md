...
>[!IMPORTANT]
>
>Launch 將以漸進方式推出給 Adobe Experience Cloud 客戶使用。如果您希望可以提早取得，請在[「Launch 發行表單」](https://adobe.allegiancetech.com/cgi-bin/qwebcorporate.dll?WVFJ3K)中輸入必填資訊讓我們知道。
...
* 微幅錯誤修正。
* 自 2018 年 3 月起，登入必須使用 Adobe ID，因為我們將不再支援 Adobe Analytics 登入程序。[更多內容...](https://marketing.adobe.com/resources/help/zh_TW/mobile/gs_signin.html)。
