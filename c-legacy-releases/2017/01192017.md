...
>[!IMPORTANT]
>
>ID 服務代碼 v2.0 依預設會自動與 [!DNL  Adobe Advertising Cloud] 同步 ID。另請參閱[了解 ID 同步和比對率](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html)。
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>您現在可以在「搜尋 &gt; 產品」中下載並顯示 Bing 商家中心 (BMC) 的帳戶資料。您也可以建立詳細目錄摘要範本與 BMC 帳戶的關聯，以便在促銷活動結構中加入摘要欄以及購物促銷活動的廣告文案。 </p> <p>若要直接在Advertising cloud中處理產品資料，您必須在Advertising cloud中建立相應的帳戶記錄，其中包含帳戶存取憑證並啟用存取權。 </p> <p>目前，下列情況支援使用 BMC 饋送: </p> <p> 
