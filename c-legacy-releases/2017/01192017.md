...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>您現在可以在「搜尋 &gt; 產品」中下載並顯示 Bing 商家中心 (BMC) 的帳戶資料。您也可以建立詳細目錄摘要範本與 BMC 帳戶的關聯，以便在促銷活動結構中加入摘要欄以及購物促銷活動的廣告文案。 </p> <p>若要直接與Advertising Cloud中的產品資料搭配使用，您必須在包含帳戶存取憑證且啓用存取權的Advertising Cloud中建立對應的帳戶記錄。 </p> <p>目前，下列情況支援使用 BMC 饋送: </p> <p> 
