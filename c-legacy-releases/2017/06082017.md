...
<table id="table_A2465769155C47F0A882D934C4B78511"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>這些結構是串聯使用的。 它們可讓iFrame中實作的不同ID服務程式碼執行個體與上層頁面上的不同執行個體相互通訊。 這些程式碼可協助解決特定使用案例中的問題，例如您可能控制或無法控制上層頁面／網域，且您在您控制之網域的iFrame中載入ID服務程式碼。 VisitorAPI.js程式碼2.2版或更新版本中提供這些功能。 請參 <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?=mcvid-whitelistdomain.html" format="https" scope="external">閱allowParentDomain和allowIframeDomains </a>。 </p> </td> 
  </tr> 
 </tbody> 
</table>
