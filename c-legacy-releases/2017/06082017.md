 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Microsoft Power BI 是一套商業分析控制面板，可分析資料及共用分析結果。Adobe Analytics 與 Power BI 的整合包含可在 Microsoft Power BI 內將 Report Builder 分析資料視覺化的功能。 </p> <p>透過 Power BI，您可以整合 Adobe Analytics 與其他資料來源 (例如銷售點、CRM)，以發掘獨特的客戶分析資料、關聯及商機，並輕鬆在組織中共用這些資訊。結合 Report Builder 的報表產生功能及 Power BI 功能後，組織中的所有人便能更容易透過網路取得資訊。 </p> <p>與 Adobe Report Builder 整合可讓您: </p> 
    ...
    </ul> <p> <a href="https://marketing.adobe.com/resources/help/en_US/arb/?f=whats_new_arb.html" format="html" scope="external"> 更多內容... </a> </p> </td> 
  </tr> 
  <tr> 
   <td> 管理工具 </td> 
  </tr> 
...
<table id="table_838639E1ED3742948C825E69584FDB05"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>資料夾特徵可讓您自動將父資料夾和子資料夾的特徵匯總到可設定目標的區段中。如需詳細資訊，請參閱<a href="https://marketing.adobe.com/resources/help/en_US/aam/?f=folder-traits.html" format="https" scope="external">資料夾特徵</a>。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* [了解對 Demdex 網域發出的呼叫](https://marketing.adobe.com/resources/help/en_US/aam/demdex-calls.html)說明 [!DNL  Audience Manager] 如何對此網域發出呼叫。
* [傳出 Hadoop 序列檔案](https://marketing.adobe.com/resources/help/en_US/aam/outbound-seq-files.html)說明如何使用二進位序列檔案將資料從 [!DNL  Audience Manager] 匯出至 Hadoop。
* [個人資料合併規則常見問題集](https://marketing.adobe.com/resources/help/en_US/aam/profile-merge-faq.html)針對[!UICONTROL 個人資料合併規則]的一些常見問題集和裝置圖問題提供解答。
* [Audience Lab 使用案例](https://marketing.adobe.com/resources/help/en_US/aam/audience-lab-use-cases.html)提供範例，說明如何使用此功能進行比較和測試。
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Media Optimizer 社群論壇已重新命名為 Advertising Cloud 社群，並位於 <a href="https://forums.adobe.com/community/experience-cloud/advertising-cloud/overview" format="https" scope="external">https://forums.adobe.com/community/experience-cloud/advertising-cloud/overview</a>。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>您現在可以使用自己的客戶關係管理 (CRM) 系統中的電子郵件清單，測試如何建立和更新 Google 客戶配對對象。請聯絡您的 Media Optimizer 帳戶管理員以瞭解更多資訊。 </p> </td> 
  </tr> 
  <tr> 
