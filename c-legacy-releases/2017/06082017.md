...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Advertising Cloud社群論壇已更名為Advertising Cloud社群，位於 <a href="https://forums.adobe.com/community/experience-cloud/advertising-cloud/overview" format="https" scope="external"> https://forums.adobe.com/community/experience-cloud/advertising-cloud/overview </a>。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>您現在可以使用自己的客戶關係管理 (CRM) 系統中的電子郵件清單，測試如何建立和更新 Google 客戶配對對象。如需詳細資訊，請洽詢您的Advertising Cloud帳戶管理員。 </p> </td> 
  </tr> 
  <tr> 
