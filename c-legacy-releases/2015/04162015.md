...
* 修正無法在 [!DNL  Marketing Cloud] 和 [!DNL  Media Optimizer]之間單一登入的問題。

**已知問題**

* 已知的問題是無法從連結 [!DNL Analytics] 帳戶擁有的報告套裝共用對象。我們積極修正
...
* 您現在可以在工作階段期間將 [!DNL  Adobe Target] 公司連結至您的IMS [!DNL  Mobile] 組織。
...
* 在資料倉庫中新增區段量度支援，修正報告與 [!DNL Analytics] 資料 *` campaign instances`* 倉庫資料之間的差異。
