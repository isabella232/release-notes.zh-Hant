...
[!DNL  Adobe Marketing Cloud] 介面中的新功能及修正。
...
* 已修正無法在 [!DNL  Marketing Cloud] 和 [!DNL  Media Optimizer] 使用單一登入功能的問題。
...
* 我們已更新 [!DNL [!DNL Analytics]] 應用程式的首次載入，以改進登入程序的速度。
...
* 我們在 Adobe Social 15.4.1.0 (2015 年 4 月) 版本中已正式放棄使用「社交應用程式」功能。這包括移除所有與應用程式相關的量度、資料和 API 方法。如有疑問，請聯絡您的 Social 帳戶管理員。如需完整詳細資訊，請參閱 [Adobe Social 應用程式 - 淘汰情況說明書](https://helpx.adobe.com/tw/social/kb/social-applications---deprecation-fact.html)。
