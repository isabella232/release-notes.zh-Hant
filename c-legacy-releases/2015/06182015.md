...
* 修正如果刪除 eVar 的值或使用處理規則將它設定為&#x200B;*`blank`*&#x200B;空白而無法 eVar 的執行個體的問題。
...
* 已變更造訪時間/現場時間營業邏輯：
   ...
   * 新增分解類別&#x200B;*`Group L: No duration`*&#x200B;可將跨越 0 秒的造訪加以分類。這些造訪現在不再包含於 *`Group A: <1 minute`*&#x200B;群組 A: &lt;1 分鐘時間值區中。
