...
* 重新編排和改進下列指南：
   ...
   * [Adobe Mobile Services 使用者指南](https://marketing.adobe.com/resources/help/zh_TW/mobile/)
   * [適用於 Marketing Cloud 解決方案的 iOS SDK 4.x 管理員手冊](https://marketing.adobe.com/resources/help/zh_TW/mobile/ios/)
...
Analytics Premium 在 [Data Workbench 6.4 發行版本](https://marketing.adobe.com/resources/help/en_US/insight/whatsnew/)中提供以下額外新功能:
...
* 目前正在重編 Swagger 的文件。如需新增和修訂後的方式，請參閱 [Audience Manager API 文件](https://bank.demdex.com/portal/swagger/index.html)一節。
* 在 [Marketing Cloud 訪客 ID](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_visitor_id_versions.html)中新增文件。您建立或編輯資料來源時，有時候會需要訪客 ID。
...
如需詳細資訊，請參閱 [Adobe Social 發行說明](https://marketing.adobe.com/resources/help/zh_TW/social/c_rel_notes.html)。
