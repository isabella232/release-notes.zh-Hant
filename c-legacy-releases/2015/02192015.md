...
<table id="table_EB3FFBA2DF904546A5185EC9A63BBA98"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>「<a href="https://marketing.adobe.com/resources/help/en_US/mcloud/groups.html" format="https" scope="external">群組對應</a>」頁面經過重新設計，現在是可讓您建立群組、新增使用者至群組以及在 Marketing Cloud 解決方案之間套用權限的管理介面。 </p> </td> 
  </tr> 
  <tr> 
...
如需詳細資訊，請參閱 [Marketing Cloud 與核心服務](https://marketing.adobe.com/resources/help/zh_TW/mcloud/)產品文件。
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> 報表 [!DNL Analytics] 導覽更新 </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>注意:  </p> <p>1. 極性量度可讓您指定當特定自訂事件 (量度) 上升時，Adobe [!DNL Analytics] 是否應該將其視為好事或壞事。 </p> <p>2. 這可讓 Adobe [!DNL Analytics] 為各種量度顯示方向指示 (箭頭) 以增加上下文 (例如每過一週的比較)。範例: 如果「提交錯誤」每週都上升，Adobe [!DNL Analytics] 應將其視為好事或壞事?另一個範例: 電子郵件註冊增加可能是好事。但表單提交錯誤增加可能是壞事。 </p> <p>在
...
>[!NOTE]
>
>此發行版本中，將會移除從第 14 版進行 Data Warehouse 存取的功能。[深入了解](https://marketing.adobe.com/resources/help/zh_TW/reference/?f=whatsnew_segments)
...
如需詳細資訊，請參閱[設定資料饋送](https://marketing.adobe.com/resources/help/zh_TW/sc/clickstream/datafeeds_configure.html)。
...
如需最新日期和發行資訊，請參閱 [Adobe Target 發行說明](https://marketing.adobe.com/resources/help/zh_TW/target/)。
