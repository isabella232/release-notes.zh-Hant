...
* 修正資產資料夾問題， [!DNL  Marketing Cloud][!DNL  Adobe Campaign] 並無法顯示相同資料夾階層的資產。
...
>[!NOTE]
>
>此發行版本中，將會移除從第 14 版進行 Data Warehouse 存取的功能。[更多詳情](https://marketing.adobe.com/resources/help/en_US/reference/?f=whatsnew_segments)
...
* 修正初始 [!DNL  SAINT][!DNL  Adobe Social] 啓用後分類不正確的問題。
