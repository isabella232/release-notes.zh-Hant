...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> 報告 <span class="wintitle"> Analytics </span> 導覽更新 </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>注意:  </p> <p>1. 量度極性可讓您指定如果指定的自訂事件(量度)上升，Adobe <span class="wintitle"> Analytics </span> 應該將其視為好事或壞事。 </p> <p>2. 這可讓Adobe <span class="wintitle"> Analytics </span> 顯示各種度量的方向指示(箭頭)，以新增上下文(例如，每周比較一周)。範例：如果「提交錯誤」每周上升，Adobe <span class="wintitle"> Analytics應 </span> 視為好事或壞事？另一個範例: 電子郵件註冊增加可能是好事。但表單提交錯誤增加可能是壞事。 </p> <p>在
