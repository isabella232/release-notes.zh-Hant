...
<table id="table_03055471A9624B40B122C0E2CD295AA9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <span class="term">「管理贏取」</span>和<span class="term">「應用程式內訊息」</span>現在只有由 [!DNL Analytics]「管理工具」管理之<span class="wintitle">「行動應用程式管理員」</span>群組中的使用者才能存取。如此可讓公司管理誰可以存取這些資源。<a href="https://marketing.adobe.com/resources/help/en_US/mobile/index.html?f=t_admin_group" format="https" scope="external"> 更多內容... </a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> </p> </td> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 貢獻分析會探索隱藏模式，說明統計異常並識別聚合讀者區段間非預期客戶動作、界外值、選定量度突升或突降背後的關聯。<a href="https://marketing.adobe.com/resources/help/en_US/analytics/contribution/?f=ca_main" format="https" scope="external"> 更多內容... </a> </td> 
  </tr> 
  <tr> 
...
* 修正密碼恢復電子郵件中，Adobe 的傳送者網域 (omniture.com) 不符合「*寄件者*」值 (adobe.com) 的問題。` From`這會導致電子郵件被封鎖，讓使用者無法收到。「*寄件者` From`」值已變更為 *。[!DNL  httpd@omniture.com]
...
>[!NOTE]
>
>已移除第 14 版的 Data Warehouse 存取。[深入了解](https://marketing.adobe.com/resources/help/zh_TW/reference/?f=whatsnew_segments)
...
如需下列產品的最新發行資訊，請參閱 [Adobe Target 發行說明](https://marketing.adobe.com/resources/help/zh_TW/target/target/r_release_notes.html)頁面:
