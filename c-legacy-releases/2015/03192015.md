...
* 修正密碼恢復電子郵件中，Adobe 的傳送者網域 (omniture.com) 不符合「*寄件者*」值 (adobe.com) 的問題。` From`這會導致電子郵件被封鎖，讓使用者無法收到。The「*寄件者*」值已變更為 [!DNL  httpd@omniture.com]。` From`
