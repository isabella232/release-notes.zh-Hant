...
在 11 月和 12 月期間，Adobe 的客戶群預計將進行大量的分類上傳。我們會盡快處理這些上傳項目，但處理時間將比平時還長。如需最大限度縮短處理時間的秘訣，請參閱[分類處理時間](https://helpx.adobe.com/tw/analytics/kb/saint-processing-time.html)。
