...
[Experience Cloud 服務與管理](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=zh-Hant)文件包含客戶屬性、對象庫 ([!UICONTROL People] 服務) 啟用、用戶和產品管理，以及 Experience Cloud Cookie。
...
| 2021 年 2 月 3 日 | [啟用非 Adobe 應用程式的資料](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-data-to-non-adobe-applications.html?lang=zh-Hant) | 影片 | 了解 Adobe 的 Real-Time CDP 如何幫助您制定真正個人化策略來吸引您的受眾。另外，瞭解它如何融入您現有的生態系統和非Adobe應用程式，這些應用程式來自Microsoft®、Google和Facebook。 |
...
* [分析管理員的重要通知](#aa-notices) **更新時間：2021年3月10日**
...
| 2021 年 2 月 1 日 | [建立SMS傳遞](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/sms-channel/create-a-sms-delivery.html?lang=zh-Hant) | Campaign Classic | 瞭解如何建立 SMS 傳送。 |
