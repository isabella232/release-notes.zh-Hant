...
| 功能 | 說明 |
| ------- | ----------- |
| 品牌安全 | （9月22日發行） [!DNL DoubleVerify] 品牌安全預先出價產品更新至 [!DNL Brand Suitability Tiers]，廣告商可針對特定區段在三個風險等級（低、中、高）之間進行選擇，而不會避免特定主題的所有例項。 在過去，段不包含任何容差級別。 |
...
| 功能 | 說明 |
| ------- | ----------- |
| 廣告分析 | （9月8日）以測試版模式提供其他深入分析。 |  | 品牌安全 | （9月22日發行） [!DNL DoubleVerify] 品牌安全預先出價產品更新至 [!DNL Brand Suitability Tiers]，廣告商可針對特定區段在三個風險等級（低、中、高）之間進行選擇，而不會避免特定主題的所有例項。 在過去，段不包含任何容差級別。 |
