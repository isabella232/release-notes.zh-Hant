...
* [分析](#analytics) 和 [Customer Journey Analytics](#cust-journey) (發佈日期： **2021年1月14日**)
...
Experience Cloud服務和管理文檔包括客戶屬性、受眾庫([!UICONTROL 人物] 服務)、激活、用戶和產品管理以及Experience Cloudcookie。
...
常規 — SDK現在使用 [!DNL XCFrameworks] 為了支援採用新AppleM1架構的硬體，同時保持對現有英特爾®架構的支援。
...
| 2020 年 12 月 9 日 | [在 Offer Decisioning 中建立規則](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/create-rules.html?lang=zh-Hant) | 影片 | 了解如何在 [!UICONTROL Offer Decisioning] 中建立規則。使用平台中的事件和屬性生成規則 [!UICONTROL 即時客戶概要資訊] 從優惠條件的限制中。 |
...
| 從 `omniture.com` 移轉至 `adobe.com` 網域 | 2020 年 8 月 21 日 | 2020 年 8 月 13 日，Adobe Analytics 將前端架構從 `omniture.com|http://omniture.com/` 移轉至 `adobe.com|http://adobe.com/` 網域。此變更應可紓解 2020 年 5 月 28 日初次統一產品網域後發生的第三方 Cookie 問題。由於此更新，瀏覽器提示用戶信任新的和 `.adobe.com|http://an.adobe.com/` 或 `experience.adobe.com|http://experience.adobe.com/` 。 |
| 更新Ad Hoc Analysis Java™ 8相容性 | 2020 年 8 月 21 日 | Ad Hoc Analysis當前與Java™ 8版本1.8.0_261+不相容。 確保您對此工具的訪問不會在 [終止日期](https://spark.adobe.com/page/S9Bhp66VJ2fEn/) 達到，Adobe建議您在1.8.0_261之前維護Java™ 8版本。 |
| Adobe Data Connectors 終止服務 | 2020 年 7 月 13 日 | Adobe [!UICONTROL Data Connectors] 的舊技術已無法使用或不再支援。Adobe在 [AdobeExchange合作夥伴計畫](https://partners.adobe.com/exchangeprogram/experiencecloud) 對於希望繼續提供和支援的任何整合，均應採用此方法。 官方的壽終日期仍有待確定，但Adobe預計，該日期將在未來12至18個月（2021年中至2021年底）。 [了解更多...](https://experienceleague.adobe.com/docs/analytics/import/dataconnectors/data-connectors-eol.html?lang=zh-Hant) |
...
Experience Manager6.5, Service Pack 7(6.5.7.0於2020年11月26日發佈)是一項重要的更新，包括自2019年4月6.5號Experience Manager正式發佈以來發佈的新功能、關鍵客戶增強功能、改進的效能、穩定性和安全性。
...
Experience Manager6.4, Service Pack 8, Cemulative Fix Pack 3(6.4.8.3於2020年11月26日發佈)是自2020年3月Service Pack 8(6.4.8.0)Experience Manager正式提供以來的一次重要更新，其中包括幾項內部和客戶修復。
...
請參閱 [CIF Venia Reference Site](https://github.com/adobe/aem-cif-guides-venia/releases/tag/venia-2020.12.01)。
   ...
   * **程式碼重構工具**
      ...
      * 新版 AIO-CLI 增效模組已正式發佈。此插件的最新版本包括Experience ManagerDispatcher Converter和Repository Modernizer的錯誤修復程式，並且還支援新的實用程式 — 索引轉換器。
請參閱 [Unified Experience](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/refactoring-tools/unified-experience.html?lang=zh-Hant#benefits)，深入了解此增效模組。
      * 索引轉換器是一種實用程式，可用於將客戶的自定義OAK索引定義轉換為Experience Manageras a Cloud Service相容的OAK索引定義。
...
* **Best Practices Analyzer**
   ...
   * [!UICONTROL Cloud Readiness Analyzer] 現在更名為 [!UICONTROL Best Practices Analyzer] (BPA)。BPA提供對您當前Experience Manager實施的最佳實踐評估，並幫助評估從現有實例遷移到AEM作為AEM一個 [!UICONTROL Cloud Service]。
...
| 2020 年 12 月 9 日 | [API 相容性](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/developer-reference-material-apis.html?lang=zh-Hant) | 文章 | 建立一個簡單的文章，明確AEM傳達哪些API(npm、Java™、HTTP)可用於各種 [!UICONTROL 資產] 操作。 |
...
| 2020 年 12 月 4 日 | [從政府發佈的文檔中使用或不使用條形碼的OCR資料提取](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/some-useful-integrations/ocr-data-extraction.html?lang=zh-Hant#some-useful-integrations) | 文章 | 從駕照或護照等政府核發的證件擷取資料，填入最適化表單。 |
...
| 2020 年 12 月 16 日 | [Dynamic Media 核心元件](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/dynamic-media-core-components.html?lang=zh-Hant) | 影片 | Experience Manager 核心元件的影像元件已內建 Dynamic Media 相關支援。瞭解影像元件如何允許內容作者在Experience Manager Sites頁面上使用Dynamic Media的功能，如影像預設、智慧裁剪和影像修飾符。 |
...
Campaign Classic、Campaign Standard和控制面板的發佈資訊。
...
| 功能 | 說明 |
| -----------| ---------- |
| 新增說明 | （10月28日發佈）舊式幫助已替換為更新的頁面，這些頁面可從主菜單中的「幫助」鏈DSP接獲得，也始終可從 [https://experienceleague.adobe.com/docs/advertising-cloud/dsp/home.html](https://experienceleague.adobe.com/docs/advertising-cloud/dsp/home.html?lang=zh-Hant) |
...
| 2020 年 12 月 29 日 | [建立可填寫的表單](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/getting-started/create-fillable-forms.html?lang=zh-Hant) | 文章 | 將在InDesign、Microsoft® Word或Excel或其他應用程式中建立的掃描紙面表單或文檔轉換為可填充的PDF表單。 |
...
| 2020 年 12 月 28 日 | [使用表單資料](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/advanced-tasks/formdata.html?lang=zh-Hant) | 文章 | 如果您有一組已完成的表單，並且必須編譯資料，則可以使用Acrobat DC將響應合併到單個電子錶格中。 |
