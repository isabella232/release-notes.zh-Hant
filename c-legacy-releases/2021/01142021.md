...
Experience Cloud服務與管理檔案包括客戶屬性、受眾程式庫（[!UICONTROL People]服務）、啟用、使用者和產品管理，以及Experience CloudCookie。
...
| 從 `omniture.com` 移轉至 `adobe.com` 網域 | 2020 年 8 月 21 日 | 2020 年 8 月 13 日，Adobe Analytics 將前端架構從 `omniture.com|http://omniture.com/` 移轉至 `adobe.com|http://adobe.com/` 網域。此變更應可紓解 2020 年 5 月 28 日初次統一產品網域後發生的第三方 Cookie 問題。更新後，瀏覽器會提示使用者將`.adobe.com|http://an.adobe.com/`或`experience.adobe.com|http://experience.adobe.com/`新網域加入信任清單。 |
| 更新Ad Hoc Analysis Java™ 8相容性 | 2020 年 8 月 21 日 | Ad Hoc Analysis目前與Java™ 8 1.8.0_261+版不相容。 為確保您在[服務終止日期](https://spark.adobe.com/page/S9Bhp66VJ2fEn/)前能順利存取此工具，Adobe建議您維護1.8.0_261之前的Java™ 8版本。 |
| Adobe Data Connectors 終止服務 | 2020 年 7 月 13 日 | Adobe [!UICONTROL Data Connectors] 的舊技術已無法使用或不再支援。Adobe在[AdobeExchange合作夥伴計畫](https://partners.adobe.com/exchangeprogram/experiencecloud)中有一項新標準，任何希望繼續提供及支援的整合都應採用此標準。 確切日期仍未決定，但Adobe預計未來12至18個月內（2021年中至2021年底）將正式終止服務。 [了解更多...](https://experienceleague.adobe.com/docs/analytics/import/dataconnectors/data-connectors-eol.html?lang=zh-Hant) |
...
Experience Manager6.5 Service Pack 7（6.5.7.0，已於2020年11月26日發行）是項重要更新，其中包括自2019年4月Experience Manager6.5全面發行以來所推出的新功能、客戶的重要增強功能，以及效能、穩定性和安全性等方面的改善項目。
...
Experience Manager6.4 Service Pack 8 Cumulative Fix Pack 3（6.4.8.3，已於2020年11月26日發行）是項重要更新，其中包括自2020年3月Experience Manager6.4 Service Pack 8(6.4.8.0)全面發行以來所推出的多項內部和客戶修正項目。
...
請參閱 [CIF Venia Reference Site](https://github.com/adobe/aem-cif-guides-venia/releases/tag/venia-2020.12.01)。
   ...
   * **Cloud Manager**
      ...
      * [IP允許清單的自助管理](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/ip-allow-lists/introduction.html)。
...
請參閱 [Unified Experience](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/refactoring-tools/unified-experience.html?lang=zh-Hant#benefits)，深入了解此增效模組。
      * Index Converter公用程式可用來轉換客戶的自訂OAK索引定義，以Experience Manager為相容Cloud Service的OAK索引定義。
...
請參閱 [AEM 雲端服務版本注意事項](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html?lang=en)。
...
* **Best Practices Analyzer**
   ...
   * [!UICONTROL Cloud Readiness Analyzer] 現在更名為 [!UICONTROL Best Practices Analyzer] (BPA)。BPA會評估您目前Experience Manager實作的最佳實務，並協助您評估從現有AEM例項移至AEM的準備程度，以作為[!UICONTROL Cloud Service]。
...
| 2020 年 12 月 9 日 | [API 相容性](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/developer-reference-material-apis.html?lang=zh-Hant) | 文章 | 撰寫內容簡潔的文章，清楚傳達各種[!UICONTROL Assets]作業可以使用哪些AEM API(npm、Java™、HTTP)。 |
...
* [AEM 雲端服務發行資訊](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/home.html?lang=en)
* [AEM Cloud Manager 版本注意事項](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/using/release-notes/release-notes-current.html?lang=en)
...
| 功能 | 說明 |
| -----------| ---------- |
| 新增說明 | （10月28日發行）舊版說明已更換為更新頁面，您可從DSP主功能表的「說明」連結加以存取，也可從[https://experienceleague.adobe.com/docs/advertising-cloud/dsp/home.html](https://experienceleague.adobe.com/docs/advertising-cloud/dsp/home.html?lang=zh-Hant)一律取得 |
...
如需最新版本的資訊，請參閱 [!DNL Marketo] [發行說明](https://docs.marketo.com/display/public/DOCS/Release+Notes%3A+7月+%2720)。
