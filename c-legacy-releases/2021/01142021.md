...
| 2020 年 12 月 7 日 | [內容片段編輯功能](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/content-fragments/content-fragments-feature-video-use.html?lang=zh-Hant) | 影片 | 此影片會概略介紹[!UICONTROL 內容片段]編輯器的進階功能。了解如何搭配[!UICONTROL 內容片段]使用註解和版本比較功能。 |
...
* 20.3.1 版 - [深入了解](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html?lang=zh-Hant#release-notes)
...
| 2020 年 12 月 4 日 | [使用 Adobe PDF Tools API 為 PDF 檔案執行 OCR 作業](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/ocr.html?lang=zh-Hant) | 文章 | 了解如何使用[!UICONTROL 光學字元辨識]，充分運用掃描的 PDF 來擷取文字，並建立可搜尋的檔案。 |
| 2020 年 12 月 4 日 | [開始使用 Adobe PDF Tools API 和 Java](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/gettingstartedjava.html?lang=zh-Hant) | 文章 | 開發人員能執行現成的範例檔案，存取所有可用的網路服務，幾分鐘內即可開始使用。本教學課程會引導您完成所有步驟，協助您開始使用 PDF Tools Java SDK 執行範例檔。 |
| 2020 年 12 月 4 日 | [開始使用 Adobe PDF Tools API 和 .Net](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/gettingstartednet.html?lang=zh-Hant) | 文章 | 開發人員能執行現成的範例檔案，存取所有可用的網路服務，幾分鐘內即可開始使用。本教學課程會引導您完成所有步驟，協助您開始使用 PDF Tools .Net SDK 執行範例檔。 |
| 2020 年 12 月 4 日 | [運用 PDF Tools API 將 PDF 轉存為 Word、PowerPoint 等格式](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/exportpdf.html?lang=zh-Hant) | 文章 | 將 PDF 檔案轉換為 MS Word，以便編輯內容、核准，之後再傳送給他人簽署，完整建立自訂合約工作流程。或者，您也能將 PDF 內容轉存為 MS Excel 格式，以利發票和財務計算或資料分析。 |
| 2020 年 12 月 4 日 | [使用 PDF Tools API 和 Node.js，在幾分鐘內以 HTML 或 MS Office 建立 PDF](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/createpdffromhtml.html?lang=zh-Hant) | 文章 | 了解如何使用全新 Adobe PDF Tools API，將文件工作流程數位化。此 API 可讓開發人員自由選擇多種強大的 PDF 操作服務，滿足複雜業務工作流程的需求。 |
