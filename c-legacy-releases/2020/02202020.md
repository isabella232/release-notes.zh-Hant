...
* [Adobe 系統狀態](#status)
* [Experience Cloud介面和核心服務](#ecloud) （添加日期） **2020年2月26日**)
...
| 更理想的訂閱和通知使用者體驗 | <ul><li>僅為要訂閱的所有產品在一個選擇中指定區域和事件首選項。</li><li>_潛在_&#x200B;問題提升為&#x200B;_輕微_&#x200B;或&#x200B;_重大_&#x200B;問題時，系統就會發送通知。</li><li>任何產品或事件狀態更新時，瀏覽器頁面會自動重新整理。</li></ul> |
...
* **基於鉻的Microsoft®邊緣瀏覽器：** 本版本包括為報告目的識別基於鉻的Microsoft®邊緣瀏覽器（79及更高版本）的更改。
...
| **[!UICONTROL 檢視封存]**&#x200B;選項的 EOL | 2019 年 10 月 30 日 | 宣佈2020年1月， **[!UICONTROL 查看存檔]** 選項(**[!UICONTROL 元件>儀表板]**)。 |
| **[!UICONTROL 強制 IP 登入限制]**&#x200B;選項的 EOL | 2019 年 10 月 30 日 | 宣佈2020年1月IP允許清單的終止日期(**[!UICONTROL 強制實施IP登錄限制]**)功能 **[!UICONTROL 管理員>公司設定>安全]** 的子菜單。 |
...
請參閱 [《 AppMeasurement for JavaScript發行說明》](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=zh-Hant)。 版本 2.19.0 已於 2020 年 2 月 21 日發行。
...
* 修復了在算法模型建立流(AAM-37942)中導航時導致UI中斷的錯誤。
* 針對使用 Adobe Experience Platform 整合的客戶，修正在新目的地或現有目的地儲存「資料匯出控制項」時，造成所選取的「資料匯出」無法儲存的錯誤 (AAM-52814)。
* 已修復錯誤，導致第三方特性建議在包含管道字元的特性中工作不正確(`|`)的AAM名稱。
* UI 中的協助工具也有多處改良。

## Experience Manager {#aem}

Adobe Experience Manager(Experience Manager)中的新功能、修復和更新。 Adobe 建議使用內部部署的客戶部署最新修補程式，以確保擁有更出色的穩定性、安全性及效能。
...
* **TutorialsExperience Manageras a Cloud Service**
   ...
   快速開始使用 [Experience Manageras a Cloud Service教程](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/overview.html?lang=en)。
...
* Adobe Campaign Classic: [文檔](https://experienceleague.adobe.com/docs/campaign-classic.html) - [How-to視頻](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/overview.html?lang=en)
