...
| 更理想的訂閱和通知使用者體驗 | <ul><li>針對您要訂閱的所有產品，只要選取一個選項，即可指定地區和事件偏好設定。</li><li>_潛在_&#x200B;問題提升為&#x200B;_輕微_&#x200B;或&#x200B;_重大_&#x200B;問題時，系統就會發送通知。</li><li>任何產品或事件狀態更新時，瀏覽器頁面會自動重新整理。</li></ul> |
...
* Adobe Campaign Classic:[檔案](https://experienceleague.adobe.com/docs/campaign-classic.html) - [作法影片](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/overview.html?lang=en)
