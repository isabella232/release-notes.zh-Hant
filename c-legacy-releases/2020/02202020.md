...
* **以Chromium為基礎的Microsoft® Edge瀏覽器：** 此版本包含多項變更，可辨識以Chromium為基礎的Microsoft® Edge瀏覽器（79版及以上版本），以利用於報表用途。
...
* **TutorialsExperience Manageras a Cloud Service**
   ...
   快速開始使用Experience Manageras a Cloud Service的[教學課程](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/overview.html?lang=en)。
...
* **Microsoft® Dynamics在 _Microsoft®中的變更擁有者_ 流程動作：** 直接從Marketo Engage變更銷售機會或連絡擁有者。
* **增強 API 呼叫功能：**
   * 使用者管理 API
   * 自訂物件結構描述 API
   * 登陸頁面重新導向規則 API
