...
AEM 6.4 Service Pack 8 Cumulative Fix Pack 2 (6.4.8.2，已於 2020 年 9 月 3 日發行) 是項重要更新，其中包括自 2020 年 3 月 AEM 6.4 Service Pack 8 (6.4.8.0) 全面發行以來所推出的多項內部和客戶修正項目。
   * [版本注意事項](https://docs.adobe.com/content/help/zh-Hant/experience-manager-64/release-notes/cfp-release-notes.html)
...
* **[!UICONTROL AEM as a Cloud Service]**
   ...
   * [!UICONTROL AEM as a Cloud Service]可讓您[將頁面和子頁面 (頁面樹狀結構) 還原為舊版](https://docs.adobe.com/content/help/zh-Hant/experience-manager-cloud-service/sites/authoring/features/page-versions.html#reinstating-versions)。
...
* **[!UICONTROL Dynamic Media]** 中的 CDN 失效
   ...
   請參閱[透過 [!UICONTROL Dynamic Media] 使 CDN 快取失效](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/assets/dynamicmedia/invalidate-cdn-cache-dynamic-media.html)。
...
| 2020 年 8 月 12 日 | [透過 AEM as a Cloud Service SDK 執行本機開發](https://docs.adobe.com/content/help/zh-Hant/experience-manager-cloud-service/commerce/develop.html) | 影片 | 了解如何為 [!UICONTROL AEM Commerce] 和 [!UICONTROL AEM as a Cloud Service ] SDK 設定本機開發環境。 |
...
| 2020 年 8 月 17 日 | [Adobe IMS 使用者](https://docs.adobe.com/content/help/en/experience-manager-learn/cloud-service/accessing/adobe-ims-users.html) | 影片 | 了解何為 Adobe IMS 使用者，並熟悉如何在 Admin Console 中存取及管理 Adobe IMS 使用者，以及如何使用 Adobe IMS 使用者登入 AEM as a Cloud Service。 |
...
* [AEM 6.4 Cumulative Fix Pack 版本注意事項](https://docs.adobe.com/content/help/en/experience-manager-64/release-notes/cfp-release-notes.html)
...
* [AEM Brand Portal 版本注意事項](https://docs.adobe.com/content/help/en/experience-manager-brand-portal/using/introduction/brand-portal-release-notes.html)
* [AEM 桌面應用程式版本注意事項](https://docs.adobe.com/content/help/en/experience-manager-desktop-app/using/release-notes.html)
