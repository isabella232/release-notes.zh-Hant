...
* 您可以使用 Adobe ID，根據產品、地區和事件偏好設定來訂閱事件通知。設定訂閱偏好設定的使用者在開啟、更新或關閉產品時，只會收到相關產品事件和維護事件的通知。 若要開始設定，請前往 [status.adobe.com/subscriptions](https://status.adobe.com/proactive-notifications/subscriptions/edit)。
...
如需產品文件，請參閱 [Experience Cloud](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=zh-tw)。

### Experience Cloud Cookie

Adobe正在調整Cookie的`same-site`設定，以因應Chrome在Chrome 80中所做的變更（預計於2020年2月發行）。
...
| 功能 | 說明 |
| -----------| ---------- |
| [加州消費者隱私權法案 (CCPA) 支援與隱私權文件大幅修改](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy.html?lang=en) | [加州消費者隱私權法案 (CCPA)](https://www.caprivacy.org/about) 自 2020 年 1 月 1 日起生效，賦予加州居民管理個人資料的新權利，並對在加州營業的特定實體加諸資料保護責任。<br><br>Audience Manager 可協助您利用 [Adobe Experience Platform 隱私權服務](https://www.adobe.com/go/privacy-overview-en) (處理存取和刪除資料的要求) 等隱私權工具，落實隱私權法規所規定的義務。<br><br>我們已更新目前的[退出管理](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy-requests.html?lang=en)程序，加入所有選擇退出的已宣告 ID (例如 CRM ID)。如果宣告的 ID 選擇退出，則宣告的 ID 和其最後連結的裝置將退出 Audience Manager 的資料收集活動。退出請求功能也會以批次和即時傳送等方式，將取消分段請求傳送給支援此功能的[目標合作夥伴](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy-requests.html?lang=en)。<br><br> 此外，我們已重新設計了 [資料安全性](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-security.html?lang=en)、 [資料隱私權](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy.html?lang=en)和 [資料](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-governance.html?lang=en) 控管檔案，讓您更輕鬆找到符合前述法規所需的資訊。 |
...
* **新功能：AEM as a Cloud Service**
   ...
   * [發行資訊](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/home.html?lang=en)
   * [文件](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html?lang=en)

* **自動化表單轉換服務**

   自動化表單轉換服務是一種將 PDF 表單自動轉換為精美行動 HTML 表單的服務，於 2019 年 12 月 12 日正式推出。

   * [簡介](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/introduction.html?lang=en)
...
* **預覽 3D 資產**
   ...
   AEM 6.5 支援 3D 資產的製作程序功能，包括上傳、傳送和互動式預覽。您可從 AEM 的資產詳細資訊頁面使用互動式 3D 檢視器。檢視器的功能包含一系列互動式相機控制機制，可供您環繞、縮放及平移 3D 資產。請參閱[預覽 3D 資產](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/previewing-3d-assets.html?lang=en)。

* **核心元件**

   現在，使用者取得核心元件 2.8.0 和許多修正項目時可一併取得[撰寫文件](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html?lang=en)，並可[在 GitHub 上取得開發人員詳細資料和下載專案](https://github.com/adobe/aem-core-wcm-components)。
...
* 設定新的子網域 - [詳細資訊](https://experienceleague.adobe.com/docs/control-panel/using/subdomains-and-certificates/setting-up-new-subdomain.html?lang=en)
