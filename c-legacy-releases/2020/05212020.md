...
>[!NOTE]
>
>訂閱[[!DNL Adobe Priority Product Update]](https://www.adobe.com/tw/subscription/priority-product-update.html)以透過電子郵件通知即將發行的版本。
...
需要協助嗎？請造訪[[!DNL Adobe Experience League]](https://experienceleague.adobe.com/#home)以尋找Adobe課程、技術檔案、快速解答、社群見解以及講師指導的訓練。
...
| -----------| --------- | ---------- |
| [!UICONTROL Workspace] 中的[!UICONTROL 「快速深入分析」]面板 | 2020 年 6 月 25 日 | [!UICONTROL 「快速深入分析」]為 [!UICONTROL Analysis Workspace] 的非分析師和新使用者提供指引，瞭解如何快速輕鬆回答業務問題。[更多詳情](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/panels/quickinsight.html) |
...
| 注意 | 新增或更新日期 | 說明 |
| -----------| ---------- | ---------- |
| 移轉至統一的產品網域 | 生效日期：2020 年 5 月 28 日 | 從 2020 年 1 月開始，Adobe Analytics 就開始移轉至統一的產品網域，相關作業已於 2020 年 5 月 28 日完成。雖然Adobe Analytics致力於從其架構移除所有`omniture.com`網域參考，但必須允許`omniture.com`做為第三方Cookie。 完整架構即將移轉完成，作業完成後我們會透過發行說明通知您，到時您就不需再執行此允許清單步驟。[以](https://helpx.adobe.com/tw/analytics/kb/adobe-ip-addresses.html) 下是建議的IP位址和網域的完整清單。<br>如果貴組織封鎖第三方 Cookie，請洽詢客戶服務人員，以重新取得 Adobe Analytics 的存取權限。 |
...
| 協力廠商技術許可 | 生效日期：2020 年 3 月 12 日 | Adobe Analytics 已開始運用協力廠商技術進行功能推出管理和產品內支援。應將下列URL新增至任何必要的網路防火牆允許清單，以確保完整功能存取：<ul><li>Gainsight：https://esp.aptrinsic.com</li><li>LaunchDarkly：https://app.launchdarkly.com</li></ul> |
...
* [AEM as a Cloud Service 發行說明](https://docs.adobe.com/content/help/zh-Hant/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)
* [AEM as a Cloud Service 文件](https://docs.adobe.com/content/help/zh-Hant/experience-manager-cloud-service/landing/home.html)
...
| [!UICONTROL 塊] | 預測系統現在會自動使用廣告商或帳戶層級區塊。 使用者不再需要將區塊貼入位置設定。 |
