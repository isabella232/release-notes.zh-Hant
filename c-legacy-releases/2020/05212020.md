...
>[!NOTE]
>
>訂閱 [[!DNL Adobe Priority Product Update]](https://www.adobe.com/tw/subscription/priority-product-update.html) 即將發佈的版本通過電子郵件通知。
...
* [[!DNL Target]](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html?lang=en) (Target 說明頁面連結)
* [[!DNL Magento]](#magento)
* [[!DNL Marketo]](#marketo)
* [[!DNL Primetime]](https://experienceleague.adobe.com/docs/primetime/release-notes/home.html?lang=zh-Hant) (Primetime 說明頁面連結)

需要協助嗎？ 訪問 [[!DNL Adobe Experience League]](https://experienceleague.adobe.com/?lang=zh-Hant/#home) 查找Adobe指導的課程、技術文檔、快速答案、社區見解和講師指導培訓。
...
* 修正無法在 [!UICONTROL Admin Console] 中複製[!UICONTROL 「產品設定檔」]權限的問題。(AN-21113)
...
| 注意 | 新增或更新日期 | 說明 |
| -----------| ---------- | ---------- |
| 移轉至統一的產品網域 | 生效日期：2020 年 5 月 28 日 | 從 2020 年 1 月開始，Adobe Analytics 就開始移轉至統一的產品網域，相關作業已於 2020 年 5 月 28 日完成。當Adobe Analytics致力於刪除 `omniture.com` 域引用來自其體系結構，必須允許 `omniture.com` 作為第三方餅乾。 完整架構即將移轉完成，作業完成後我們會透過發行說明通知您，到時您就不需再執行此允許清單步驟。[這裡](https://helpx.adobe.com/tw/analytics/kb/adobe-ip-addresses.html) 是建議的IP地址和域的完整清單，您應該允許。<br>如果貴組織封鎖第三方 Cookie，請洽詢客戶服務人員，以重新取得 Adobe Analytics 的存取權限。 |
...
| [!UICONTROL 塊] | 預測系統現在自動使用廣告商或帳戶層塊。 用戶不再需要將塊貼上到放置設定中。 |
