...
請參閱[JavaScript適用的AppMeasurement發行說明](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=en)。 2.20.0 版已於 2020 年 3 月 5 日發行。
...
請參閱[使用智慧型裁切](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/adding-dynamic-media-assets-to-pages.html?lang=en)。
...
* Adobe Campaign Classic：[文件](https://experienceleague.adobe.com/docs/campaign-classic.html) - [版本說明](https://final-docs.campaign.adobe.com/doc/AC/en/RN.html) - [做法影片](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/overview.html?lang=zh-Hant)
...
| [!DNL Adobe Campaign] | 教學課程 - [使用 Android 的推播通知™](https://experienceleague.adobe.com/docs/campaign-standard-learn/getting-started-with-push-notifications-android/introduction.html?lang=en) | 將個人化和分段的推播通知傳送至iOS和Android™行動裝置。 本教學課程會逐步帶您了解從Adobe Campaign傳送推播通知以及在Android™應用程式中接收這些通知的相關步驟。 |
