...
| [!DNL Adobe Campaign] | 教學課程 - [使用 Android 的推播通知™](https://experienceleague.adobe.com/docs/campaign-standard-learn/getting-started-with-push-notifications-android/introduction.html?lang=en) | 將個人化和分段的推播通知傳送至iOS和Android™行動裝置。 本教學課程將逐步帶您瞭解從 Adobe Campaign 傳送推送通知以及在 Android™ 應用程式接收這些通知的相關步驟。 |
