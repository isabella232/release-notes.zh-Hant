...
* [[!DNL分析]](#analytics) (發 **行日期變更——請參閱4月15日的更新)**
...
| [Java Content Repository (JCR) 簡介](https://docs.adobe.com/content/help/en/experience-manager-learn/cloud-service/underlying-technology/introduction-jcr.html) | Adobe Experience Manager使用的Java內容存放庫(JCR)簡介。 |
