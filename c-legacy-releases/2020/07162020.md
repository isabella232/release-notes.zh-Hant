...
* [分析](#analytics) 和 [Customer Journey Analytics](#cust-journey) （2020年7月14日更新）
...
* [分析管理員的重要通知](#aa-notices) （2020年7月13日更新）
...
| 功能 | 說明 |
| -----------| ---------- |
| GDPR透明度和同意框架 | Advertising Cloud正在將對國際調查局《透明度和同意框架》的支援升級為2020年8月15日之前的2.0版。 此時，客戶端不需要更改。  作為我們每個客戶的資料處理器，Adobe Advertising Cloud擁有可供客戶履行GDPR義務的能力，這些義務適用於我們產品和服務的使用。 |
| Audience Manager整合 | (僅限Adobe Audience Manager客戶的Beta版)DSP可以通過Adobe Experience Platform將包含廣告商廣告參與資料的可操作日誌檔案發送到Audience Manager。 在Audience Manager中，廣告商可以使用資料在深入分析工具(如Audience Optimization報告)中進行高級細分和使用。 |
| 基於人的交叉設備圖目標 | 自助式客DSP戶可以使用設備圖(Adobe設備合作或LiveRamp)，在新的市場活動中進行基於人的目標和頻率管理。 這確保廣告商能夠通過自己擁有的設備接觸到他們的受眾，但限制曝光。 此外，跨放置的跨設備目標設定的批量編輯現在處於測試版中。 要為您的帳戶啟用測試版，請與Adobe客戶經理聯繫。 |
| 站點目標 | 「黑名單」和「白名單」被更名為「blocked(sites)」和「targed(sites)」等更為公平的術語。 |
| 閃電廣告 | 現DSP在，通過單個廣告建立和批量第三方廣告建立工作流自動為所有Flashtalking ad標籤插入按一下宏。 |
| 報表 | (僅限Adobe Experience Platform客戶試用版)Advertising Cloud Search的新跨渠道報告提供了媒體支出和搜索的統一視圖DSP，並提供了投放和搜索活動的DSP每日關鍵指標。 |
