...
如需 [累計發行說明](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-release-notes.html) ，請參閱Experience Cloud ID服務。
...
* 更新記錄(X、B) [量度語法檔案的說明](https://marketing.adobe.com/resources/help/en_US/insight/client/c_syntx_mtrc_exp.html) 定義。 (AN-180527)
...
AEM 6.5 clientlibs快取失效的重要AEM修補程式可透過 [AEM 6.5.1.0更新或此](https://helpx.adobe.com/experience-manager/6-5/release-notes/sp-release-notes.html) KB文章取得 [](https://helpx.adobe.com/experience-manager/kb/avoid-crx-quickstart-deletion-in-aem-6-5.html)。
...
* Adobe Campaign Classic [19.1.2](https://docs.campaign.adobe.com/doc/AC/en/RN.html) —— 組建版本9029
...
* [Magento Open Source 2.3.2發行說明](https://devdocs.magento.com/guides/v2.3/release-notes/ReleaseNotes2.3.2OpenSource.html)
* [Magento Commerce 2.3.2發行說明](https://devdocs.magento.com/guides/v2.3/release-notes/ReleaseNotes2.3.2Commerce.html)
