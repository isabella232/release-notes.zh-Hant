...
* 有關[!DNL Experience Platform]的最新更新，請參閱Adobe.io上的[Adobe Experience Platform發行說明](https://www.adobe.io/apis/experienceplatform/home/services/release-notes.html#!end-user/markdown/release-notes/release-notes-20190515.md)。
...
| **區段** | 新區段運算子: **[!UICONTROL 等於任何]**&#x200B;和&#x200B;**[!UICONTROL 不等於任何]**。[深入了解...](https://docs.adobe.com/content/help/en/analytics/components/segmentation/segment-reference/seg-operators.html) |
...
| **Analytics 文件改善** | Analytics 文件已重新整理，現已納入可供您改善內容的協同作業功能! 您可以記錄文件的相關問題，並提出編輯建議。文檔集已移到[new domain](https://docs.adobe.com/content/help/zh-Hant/analytics/landing/home.html)。 重新導向應該已可正常運作。 |
| **新技術說明使用者指南** | [Tech Notes使用指南](https://docs.adobe.com/content/help/zh-Hant/analytics/technotes/home.html)現已推出。 目前，該指南旨在協助使用者更熟悉第三方分析工具 (例如 Google Analytics)，以便在使用 Adobe Analytics 時更快上手。接下來幾個月期間，技術說明使用者指南會增加更多內容。 |
...
| 注意 | 新增或更新日期 | 說明 |
| -----------| ---------- | ---------- |
| 資料收集更新 | 新增日期：2019 年 6 月 27 日 | 所有具有「same-site-by-default-cookies」旗標的Adobe AnalyticsCookie現在都將此旗標設為`SameSite=None`。 |
...
| 防護性、健全性與可擴充性 | [!DNL Campaign Classic] 已新增一系列改善項目。[《Adobe Campaign Classic發行說明》](https://docs.campaign.adobe.com/doc/AC/en/RN.html)中列出了增強的護欄、魯棒性和可擴充性。 |
...
| 功能 | 說明 |
| ------------- | ----------- |
| 控制面板 | 您可以輕鬆監控例項容量和管理其設定 (從 SFTP 伺服器管理開始)，協助您提高作為管理員使用者身分的工作效率。<br>如需詳細資訊，請參閱[詳細文件](https://helpx.adobe.com/campaign/kb/control-panel.html)和[操作影片](https://helpx.adobe.com/tw/campaign/kt/acs/using/acs-control-panel-video-use.html)。 |
