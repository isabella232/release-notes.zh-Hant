...
* [特徵摘要頁面](https://experiencecloud.adobe.com/resources/help/zh_TW/aam/c_tb_trait_summary.html)現在會顯示特徵類型。(AAM-25784)
* [區段摘要頁面](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_segment_summary.html)現在包含區段資料來源的超連結，可更輕鬆導覽。(AAM-40015)
* 修正區段產生器中目的地對應模式的問題，該問題會導致使用者多次按下「新增目的地」按鈕時，系統不僅建立單一對應，而會建立多個對應。(AAM-37177)
* 修正[選取排除特徵](https://experiencecloud.adobe.com/resources/help/en_US/aam/trait-exclusion-algo-models.html)頁面中，演算法模型裡缺少&#x200B;**[!UICONTROL 「全部選取」]**&#x200B;核取方塊的錯誤。(AAM-42462)
