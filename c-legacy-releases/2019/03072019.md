...
| [全球資料來源](https://marketing.adobe.com/resources/help/en_US/aam/global-data-sources.html) | 所有 Audience Manager 客戶均可使用全球資料來源，內含 Apple、Samsung、Microsoft、Roku 和 Android 裝置製造商所產生的裝置廣告 ID。這些 ID 由製造商提供，用於廣告目的。您可以使用全球資料來源同步裝置 ID，並匯入或匯出這些對應所中斷的資料。<br/>Audience Manager 會根據格式，驗證客戶匯入的裝置廣告 ID (DAID)，確保符合裝置製造商列出的標準格式。 |
...
[推出新Adobe Experience Manager—適用於行銷人員與IT的進階客戶體驗管理(CXM)的雲端](https://theblog.adobe.com/adobe-experience-manager-2019-cloud-content-personalization-CXM/)、內容和個人化增強功能。
