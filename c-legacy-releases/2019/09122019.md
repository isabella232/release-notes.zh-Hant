...
>[!NOTE]
>
>訂閱[[!DNL Adobe Priority Product Update]](https://www.adobe.com/tw/subscription/priority-product-update.html)以透過電子郵件通知即將發行的版本。 您會在發行前三至五個工作天收到通知。 產品發行後才發佈的新資訊皆會標示發佈日期。
...
| 功能 | 說明 |
| -----------| ---------- |  
| **[[!DNL People-Based Destinations]](https://docs.adobe.com/content/help/zh-Hant/audience-manager/user-guide/features/destinations/people-based/people-based-destinations-overview.html)** | [!DNL People-Based Destinations] 是一種付費的 Audience Manager 附加元件，可協助您使用雜湊識別碼 (例如電子郵件地址)，在各種以人員為基礎的環境 (例如 Facebook) 中啟用第一方對象區段。 |
...
[!DNL Digital Publishing Suite Classic] (DPSC) 即將於 2019 年 8 月 31 日終止服務。如需詳細資訊，請參閱[[!DNL Digital Publishing Suite Classic] 生命週期結束常見問答集](https://helpx.adobe.com/tw/digital-publishing-suite/help/eol-statement-for-dpsc.html)。
...
* [Scene7出版系統發行說明](https://docs.adobe.com/content/help/en/dynamic-media-developer-resources/release-notes/s7rn2017.html)
* [Livefyre 發行說明](https://docs.adobe.com/content/help/en/livefyre/using/release-notes/c-rn.html)
...
我們已新增功能，讓管理員使用者可以允許IP位址連線至Campaign Classic例項。
