...
>[!NOTE]
>
>訂閱 [[!DNL Adobe Priority Product Update]](https://www.adobe.com/subscription/priority-product-update.html)，即可透過電子郵件接收即將發行版本的相關通知。您會在發行前三至五個工作天收到通知。 產品發行後才發佈的新資訊皆會標示發佈日期。
...
| 分析工作區除錯程式命令即將變更 | 2019 年 4 月 4 日 | **2019 年 6 月 13 日**，開啟 Analysis Workspace 偵錯工具的控制台命令將變更為 adobeTools.debug.includeOberonXml。adobe.tools.debug.includeOberonXml 自當天起將無法使用。 |
...
| 功能 | 說明 |
| -----------| ---------- |  
| **[[!DNL 以人員為基礎的目的地]](https://docs.adobe.com/content/help/zh-Hant/audience-manager/user-guide/features/destinations/people-based/people-based-destinations-overview.html)** | [!DNL People-Based Destinations] 是一種付費的 Audience Manager 附加元件，可協助您使用雜湊識別碼 (例如電子郵件地址)，在各種以人員為基礎的環境 (例如 Facebook) 中啟用第一方對象區段。 |
| **[將 Twitter 量身打造的對象設定為自助式以裝置為基礎的目的地](https://docs.adobe.com/content/help/zh-Hant/audience-manager/user-guide/features/destinations/device-based/twitter-tailored-audiences.html)** | 我們正在將 Twitter 目的地移轉至自助服務設定模型。本文說明為了在移轉後繼續使用現有 Twitter 整合所需採取的動作。 |
| **[對象市集計費範例](https://docs.adobe.com/content/help/zh-Hant/audience-manager/user-guide/features/audience-marketplace/audience-marketplace-for-data-buyers/marketplace-buyer-billing.html#billing-examples)** | 我們新增了一個案例 3 的範例，說明帳單如何適用於具有啟用和模型使用案例的區段。 |
...
在[這裡](https://helpx.adobe.com/tw/experience-manager/6-5/assets/using/config-smart-tagging.html#Obtainpubliccertificate)瞭解如何在憑證過期之後更新。
...
[!DNL Digital Publishing Suite Classic] (DPSC) 即將於 2019 年 8 月 31 日終止服務。For more information, see the [[!DNL Digital Publishing Suite Classic] End-of-Life FAQ](https://helpx.adobe.com/tw/digital-publishing-suite/help/eol-statement-for-dpsc.html).
...
我們已新增功能，讓管理員使用者可允許IP位址連線至Campaign Classic例項。
此外，管理員使用者現在也能檢視例項清單，並具備版本升級資格。如需詳細資訊，請參閱[專屬文件](https://helpx.adobe.com/tw/campaign/kb/control-panel-instance-settings.html)。
