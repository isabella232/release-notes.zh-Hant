...
瞭解如何在憑證過期後更新 [此處](https://helpx.adobe.com/experience-manager/6-5/assets/using/config-smart-tagging.html#Obtainpubliccertificate)。
...
現已推出 AEM Forms 自動化表單轉換服務的說明文件。請參 [閱自動表單轉換服務簡介](https://helpx.adobe.com/experience-manager/Automated-Forms-Conversion-Service/introduction-to-automated-form-conversion-service.html)。
...
* [Campaign Classic 19.1.5更新](https://docs.campaign.adobe.com/doc/AC/en/RN.html#9033) -組建9033
