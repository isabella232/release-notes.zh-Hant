...
# [!DNL Adobe Experience Cloud] 發行說明- 2019年1月
...
在 8.1 版中，我們讓 DIL 遵循 Google Tag Manager 更嚴格的安全性原則。This version is only available from DTM and as standalone code, not [!DNL Launch] or AppMeasurement Audience Manager Module. 未來版本將會包含此一變更。(CORE - 24189)
