...
* [Target](https://docs.adobe.com/content/help/en/target/using/release-notes/target-release-notes.html) (解決方案說明連結)
...
升級到 Tableau 的新版本後，我們變更了重疊報表的資料視覺效果方法。請參閱區段對特徵重疊報表中的螢幕截圖。請參閱[區段對特徵重疊報表](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_segment_trait_overlap.html)
...
* [發行說明](https://helpx.adobe.com/tw/experience-manager/release-notes--aem-6-1-cumulative-fix-pack-.html)
* [AEM Forms CFP 發行版本](https://helpx.adobe.com/tw/aem-forms/kb/aem-forms-releases.html)

### 自助式

如需 AEM 整合問題的疑難排解秘訣，請參閱[疑難排解整合問題](https://helpx.adobe.com/tw/experience-manager/6-4/sites/administering/using/troubleshooting-integration-issues.html)。
...
[Adverising Cloud 社群](https://forums.adobe.com/community/experience-cloud/advertising-cloud)
