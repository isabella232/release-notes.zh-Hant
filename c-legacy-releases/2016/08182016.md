...
在相同頁面上使用 [!DNL  Audience Manager] DIL程式碼和VisitorAPI. js代碼的客戶應設定DIL變數 ` secureDataCollection= false`。請參閱 [secureDataCollection](https://marketing.adobe.com/resources/help/en_US/aam/?f=dil-secure-data-collection.html)。
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>「視訊同時觀看者數報表」會顯示該日中同時收看的觀眾數。您可依內容、裝置類型或國家/地區來篩選這項資料。<a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/hbvideo/c_vhl_video-concurrent-viewers-dashboard.html" format="https" scope="external"> 更多... </a></p> </td> 
  </tr> 
 </tbody> 
</table>
...
* 依預設，DIL 現在可以建立安全的 HTTPS 呼叫。在相同頁面上使用 [!DNL  Audience Manager] DIL程式碼和VisitorAPI. js代碼的客戶應設定DIL變數 ` secureDataCollection= false`。請參閱 [secureDataCollection](https://marketing.adobe.com/resources/help/en_US/aam/?f=dil-secure-data-collection.html)。
