...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Adobe 現已加入 <a href="https://marketing.adobe.com/resources/help/en_US/implementation/accelerated-mobile-pages.html" format="https" scope="external">Accelerated Mobile Pages</a> (AMP) 專案。AMP 是一項開放原始碼專案，可讓您建立快速轉譯靜態內容的網頁。這項功能相當適合發佈者使用，因為他們只需建立一次行動最佳化內容，即可在任何地方立即載入。 </p> <p>注意：此專案不會影響報告結果。 </p> </td> 
  </tr> 
  <tr> 
...
* 修正無管理權限之使用者也能建立設定檔合併規則的錯誤。(AAM-22433)
