...
修改適用於 [!DNL  Analytics] 客戶的 ID 服務實作程序。請參閱[設定 Marketing Cloud ID 服務與 Analytics](https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-setup-analytics.html)。
