...
修改適用於 [!DNL  Analytics] 客戶的 ID 服務實作程序。請參閱[使用 Analytics 設定 Marketing Cloud ID 服務](https://marketing.adobe.com/resources/help/zh_TW/mcvid/?f=mcvid-setup-analytics.html)。
...
* [Adobe Campaign v6 發行說明](https://marketing-stage.adobe.com/resources/help/zh_TW/whatsnew/)
