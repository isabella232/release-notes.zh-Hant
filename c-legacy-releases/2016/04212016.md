...
如需詳細資訊，請參閱 [Marketing Cloud 的新功能 - 2016 年春季](https://marketing.adobe.com/resources/help/zh_TW/mcloud/marketing-cloud-interface.html)。
...
文件內含 [!DNL  Target] 的新程序內容。請參閱[使用 Analytics 實作 Marketing Cloud ID 服務](https://marketing.adobe.com/resources/help/zh_TW/mcvid/?f=mcvid-setup-target.html)。
...
>[!IMPORTANT]
>
>在更新的 Marketing Cloud 介面，您可以從 **[!UICONTROL Analytics]** &gt; **[!UICONTROL 工具]**功能表存取 Search&amp;Promote。或是直接使用以下頁面登入: [https://center.atomz.com/center/](https://center.atomz.com/center/)。
