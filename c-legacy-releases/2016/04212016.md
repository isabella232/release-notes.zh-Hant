...
文件內含 [!DNL  Target] 的新程序內容。See [Implement the Marketing Cloud ID Service With Analytics ](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-setup-target.html).
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </codeblock> <p>Affected versions are <span class="term"> AppMeasurement for Flash </span> version 4.0 and earlier on all platforms. </p> <p>注意: 基於安全性考量，我們將不再發佈 AS2 版 <i>Flash 適用的 AppMeasurement</i>。不過，我們仍將持續支援現有 AS2 專案的資料收集功能。僅管如此，我們強烈建議客戶將實作升級至 AS3，且導入 <i>Flash 適用的 AppMeasurement</i> 的最新安全性功能。 </p> <p> <span class="term"> 受此問題影 </span> 響的AppMeasurement for Flash客戶必須使用可從Analytics Console下載的更新程式庫重建專案 <a href="https://help.adobe.com/en_US/Flex/4.0/UsingFlashBuilder/WS6f97d7caa66ef6eb1e63e3d11b6c4d0d21-7feb.html#WS6f97d7caa66ef6eb1e63e3d11b6c4d0d21-7f88" format="http" scope="external"> .... </a> (AN-121780) </p> <p> <b><span class="keyword"></span>  其他平台的 AppMeasurement</b> </p> <p>如需下列平台上 <span class="keyword">AppMeasurement</span> 的版本記錄，請參閱 <a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/release/index.html" scope="external" format="https">AppMeasurement 版本記錄</a>: </p> 
