---
description: 發行說明2016年7月
keywords: 發行說明
seo-description: 發行說明2016年7月
...
如需產品檔案，請參閱[AdobeMobile Services](https://marketing.adobe.com/resources/help/zh_TW/mobile/)。 若要參閱先前版本的發行說明，請展開左側面板的&#x200B;*先前發行說明*。

### 動態標籤管理 {#dtm}

| 功能 | 說明 |
|---|---|
| Marketing CloudID服務工具 | 現在預設會啟用讓DTM載入中的Marketing CloudID服務工具位於頁面頂端的選項。 |
...
此版本將版本增至1.6.0。它包含下列功能、錯誤修正和其他變更。
...
<table id="table_0CF2AF14F0E64FA7A48C340C3D94E98F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>AppMeasurement代碼需求 </p> </td> 
...
<table id="table_BEDD720754F84255A64598018911E336"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>CORS 可讓瀏覽器從現行網域以外的網域請求資源。<span class="keyword">Marketing Cloud</span> ID 服務支援 CORS 標準，以允許用戶端、跨原始資源要求。此 ID 服務在不支援 CORS 的瀏覽器上會回復為 JSONP 請求。(AAM-23988)
 </p> <p>請參閱: </p> 
    <ul id="ul_36247A565B5842B3A5F0553440327BC8"> 
     <li id="li_1DBEEFBA4C4B452BAADCE86B102DD337"> <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-cors.html.html" format="https" scope="external"> Marketing Cloud ID 服務中的 CORS 支援 </a> </li> 
...
* 將預設 ` loadTimeout` 值從 500 毫秒變更為 30,000 毫秒 (30 秒)。請參閱 [ID 服務 getInstance 函數使用的變數](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid_getinstance.html)。(MCID-96)
* 將 ` d_fieldgroup` 參數新增至 ` dpm.demdex.net` 的 ID 同步呼叫。這個新參數可用於內部疑難排解和偵錯。(MCID-94)
* 在 ID 服務 iFrame 中新增了標題屬性。iFrame 標題可協助螢幕助讀程式為需要協助的使用者提供頁面資訊，以便他們操作線上內容。iFrame 標題屬性設為 ` Adobe ID Syncing iFrame`。(MCID-81)
* 新增 ` idSyncAttachIframeASAP: true` 作為選用旗標，您可以在 ` Visitor.getInstance` 函數中加以設定。若為 ` true`，ID 服務便會儘快載入 ID 同步 iFrame。其目的是要改善 ID 同步匹配率。依預設，ID 服務會在視窗載入時載入 iFrame。(MCID-86)

**新文件及修訂的文件**

* 新: [針對 Analytics 和 Audience Manager 實作 Marketing Cloud ID 服務](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-setup-aam-analytics.html)
* 修訂: [測試及驗證 Marketing Cloud ID 服務](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-test-analytics.html)

另請參閱 [Marketing Cloud ID 服務](https://docs.adobe.com/content/help/en/id-service/using/home.html)產品文件。
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>在 2016 年 10 月時，Analytics 管理員將能在 <span class="wintitle">Enterprise Dashboard</span> 中管理使用者和產品組態 (群組)。Enterprise Dashboard是Adobe行銷、創意和Document Cloud的管理介面。 </p> <p>您將能夠： </p> 
    <ul id="ul_BD8F095B2A2D48379928C1E4D6B86F63"> 
     <li id="li_922FB8DE1BC34567AA5316C230E27779">建立產品、工具、產品、報表套裝（等等）的產品設定。 </li> 
     <li id="li_598E3DA610694E13B3B0C2294E8B8096">建立使用者並指派給產品設定。 </li> 
     <li id="li_CECBE177CFC4491CB460FA0A93C93B31">將管理角色委派給特定產品設定的使用者。 </li> 
     <li id="li_E8FD5A1C454F4AE4BE00B3CD9EB7BE4F">套用權限至特定維度和量度。 </li> 
    </ul> <p>此外，目前的「管理工具」使用者管理功能將會收到重要的增強功能。 </p> <p> <p class="important">注意: 如需詳細資訊，請參閱 <a href="https://marketing.adobe.com/resources/help/en_US/reference/permissions-changes.html" format="html" scope="external">2016 年秋季的管理產品變更</a>。 </p> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> AppMeasurement forFlash-安全性更新 </td> 
 ...
 <p>Adobe 已發行<a href="https://helpx.adobe.com/tw/security/products/analytics/apsb16-13.html" format="https" scope="external">安全性更新 APSB16-13</a>，針對 <span class="term">Flash 適用的 AppMeasurement</span> 資料庫。此更新解決資料庫中重大漏洞，但僅限於啟用 <span class="codeph">debugTracking</span> 時，此時可能會遭濫用而進行 <a href="https://www.owasp.org/index.php/DOM_Based_XSS" format="https" scope="external">DOM 型 XSS 攻擊</a>。 </p> <p> <p class="important">注意：此問題會影響 <span class="term">Flash 適用的 AppMeasurement</span>，但僅限於啟用 <span class="codeph">debugTracking</span> 時 (在預設設定中停用 <span class="codeph">debugTracking</span>)。<b>如果受影響，我們強烈建議立即停用 <span class="codeph">debugTracking</span>。</b>下列為部分範例程式碼: </p> </p> 
  ...
  <tr> 
   <td colname="col1"> SiteCatalyst14、ExcelClient等 2016年9月終止 </td> 
   <td colname="col02"> <p>2016 年 3 月 17 日 </p> </td> 
   <td colname="col2"> <p>SiteCatalyst14、ExcelClient和許多其他舊式元件將於2016年9月結束生命週期。 </p> <p>這表示我們即將移除 SiteCatalyst 14 使用者介面和數項相關功能的所有存取權。為了準備好因應措施，請檢視這份受影響元件的<a href="https://marketing.adobe.com/resources/help/en_US/sc/user/upgr_home.html" format="https" scope="external">清單</a>，以及使用者如何改採其他方法以繼續使用的所需行動和建議說明。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>2016 年 2 月 18 日 </p> </td> 
   <td colname="col2"> <p>Adobe的地理服務提供商正在改變我們接收英國郵遞區號的方式。 我們將在3月18日或前後，從提供截斷的英國郵遞區號轉換為完整郵遞區號。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>所有報表套裝存取權 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>透過 <span class="keyword">Marketing Cloud</span> 登入 <span class="keyword">Analytics</span> 的新客戶可使用 <span class="term">Adobe Analytics 快速入門</span>方式快速實作 <span class="keyword">Analytics</span>，然後使用「動態標籤管理」部署 Analytics。 </p> <p>此簡化實作由動態標籤管理代管，可讓您： </p> 
    <ul id="ul_2479AF2B543E4C2A995A83216A4B4ABE"> 
     ...
     <li id="li_0BF98AA4DF7A4713A9E04583E98E5B6C">部署Analytics和Marketing CloudID服務。 </li> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <b>Developer Connection 內容更新</b> (新增日期: 2016 年 7 月 25 日) </p> <p><a href="https://marketing.adobe.com/developer/documentation/classifications-1-4-saint/r-createexport" format="https" scope="external">Classifications.CreateExport</a> 的更新: </p> 
    ...
    </ul> <p> <b>淘汰通知</b> </p> <p> 網站服務API 1.2版已於2014年2月20日正式停用。 將於2016年9月15日結束。 屆時，Adobe將移除API伺服器回應1.2版API要求的能力。 向 <span class="filepath">https://api.omniture.com/admin/1.2</span> 端點提出任何 API 請求都將傳回 404 錯誤。 
     </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_79999DF08A424BFDA59BDBCD2E738A4C"> 
      ...
      <li id="li_562AFA713CA34C009DC2FB0B4B8A26EF">管理員：修正無法追蹤使用其Adobe ID透過Marketing Cloud登入之使用者的活動問題。 此修正會複製傳統上透過公司名稱、使用者名稱和密碼登入的使用者的活動追蹤。 (AN-124792) </li> 
      <li id="li_0BDA039583054473BC3190E0AF57D03D">修正共用計算量度無法套用至非管理員使用者的問題。 (AN-125412) </li> 
      <li id="li_A5B1C8700C56426AACECBFF448DB06B3">修正即使報表未排程進行散發，仍會傳送報表的罕見問題。 (AN-126552) </li> 
      <li id="li_D1237FEB03554D7793CCF09148F32530">已修正預設產品登入為SearchCenter的使用者發生的登入問題(AN-126281)。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_6F297BE1227F4A09B3B6E69330CE648E"> 
      <li id="li_602B55D4F7DF4D0C8B240C0B43679808"> 排程的專案現在會使用報表套裝的時區，而非瀏覽器的時區。 (AN-126233) </li> 
      <li id="li_56A2CDE08D274BE897DB1DC7EDAE61B1">在<span class="wintitle">「計劃的專案」</span>中新增了指定專案 PDF 寬度的功能。(AN-124242) </li> 
      <li id="li_413B05B2DE7B4910B80A334A4AD8D26A"> 修正在Chrome瀏覽器中預覽PDF專案時，下載PDF專案時發生的錯誤。 (AN-123674) </li> 
      <li id="li_4584537608434E7CBCBCC18EA8F01B59">修正元件無法放置和調整大小的問題（在少數情況下）。 (AN-126175) </li> 
      <li id="li_976D720D2919457A91C2F4CC5DCBB54F">修正新增瀏覽器區段，然後變更表格中的瀏覽器類型時所發生的區段定義問題。 (AN-126086) </li> 
      <li id="li_C6B5C8D3ED38475889EDBBB7DFC0E4F3">修正每週專案排程中，造成介面中無法正確顯示一週中的某天的問題。 (AN-125760) </li> 
      ...
      <li id="li_D8E69F309E144BCB999B19B59AE502A4">修正登入後無法顯示專案控制面板的隨機問題。 (AN-124635) </li> 
      <li id="li_7B10BCEA62D1427BB5A7574A88B756FD">已修正使用多個度量和區段之專案的表格排序問題。 (AN-126162) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BB48AEAB77574B79A823FBA770449105"> 
      ...
      <li id="li_11C668A5F12F46C0969C279F33F3AC6D">從Activity Map移除不支援的覆蓋度量（新訪客和新客戶）。 (AN-124056) </li> 
      <li id="li_44571DB551274B25A37C13F0D0A8505A"> 「Activity Map即時」模式現在會報告網頁中顯示的所有連結。 (AN-116094) </li> 
      <li id="li_7044F2E995024A48873E6209146C1678">修正重新載入頁面後，計算量度無法顯示的問題。 (AN-125900) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Report Builder </td> 
   <td colname="col2"> <p> 已改善排程活頁簿的支援，這些活頁簿最初是從Excel Web介面透過Office 365開啟。 (AN-118240 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_21AA1745F6154EFAA67D00D9531417D3"> 
      ...
      <li id="li_59787469534B455686696BA9E095D388"> 修正規則中，「0」雜湊值出現在分類查閱表格中的區段邏輯問題(AN-125340)。 </li> 
      <li id="li_047E532F694B4999BC3EF156FA8029AC">新增可傳送空白報表，而非回應「無資料」的功能。 (AN-126210) </li> 
      <li id="li_4D264642BB344468A8A6E2D6EB3B7C82">現在在 Data Warehouse 中，介面的虛擬報表套裝變更後，會建立新的電子郵件分送清單。(AN-123842) </li> 
      <li id="li_74CFDE5092ED471594A4EE8893D2ADEA">劃分功能現在會在產生的電子郵件中提供正確的MIME類型(AN-124243) </li> 
      <li id="li_93364B7D632E49C5AE6C222BCBE5EC1F">修正無法顯示參與率量度名稱的問題。 (AN-117260) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
     ...
     <ul id="ul_3AAA9C4D782142DEBC1575283AE90CC5"> 
      ...
      <li id="li_C64B1DCB5679439A8FD77CF03A4D5F3B">修正AppMeasurement在訪客API中呼叫錯誤模糊化方法的問題。 (AN-126006) </li> 
      <li id="li_B9E05F749D93432C8D5D7A7D1BA0A070">修正造成JavaScript錯誤的問題："屬性僅對v:image有效"。 (AN-124009) </li> 
     </ul> </p> 
<!-- <draft-comment> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>範例錯誤報告 </p> </td> 
   <td colname="col2"> <p><span class="wintitle">「範例錯誤報表」</span>會檢查成敗比率，以處理傳入資料來源檔案中的記錄。錯誤報告會在互動式長條圖中顯示資料，並以表格形式提供摘要度量。 此外，它還包含一個選項，可以在固定時間間隔內對檔案進行採樣，並顯示每種錯誤類型最常見的錯誤。 </p> <p>當功能於7月底發佈時，將會提供說明檔案。 </p> </td> 
  </tr> 
  <tr> 
...
* 將Google Bid Manager從v201601升級至v201603。 (AAM-24618)

* 修正「描述檔合併」規則報告顯示0的錯誤。 (AAM-24685)

* 修正客戶因稽核表格中的唯一金鑰錯誤而無法編輯或刪除使用者群組的錯誤。 (AAM-24864)

* 已修正S2S和大量S2S目的地未強制執行限制的錯誤。 (AAM-24905)

* 已變更行的樣式，將舊版登入和Marketing Cloud分隔。 (AAM-24378)

* 修正刪除使用者、群組或資料來源後，會顯示錯誤訊息的錯誤。 (AAM-24638)
...
* [大量管理快速入門](https://marketing.adobe.com/resources/help/en_US/aam/c_bulk_start.html):內含新的大量管理試算表。
* [使用平台階層的索引鍵進行地理定位](https://marketing.adobe.com/resources/help/en_US/aam/c_tb_platform_vars.html):納入含有最新值的更新索引鍵清單。

**修正、改良及淘汰內容**

* 已修正回覆推文時產生錯誤，指出推文超過140個字元的問題。
* 修正啟用特定連結縮短程式的切換按鈕無法運作的問題。
* 修正協調者回覆無法顯示在「協調」中的問題。
...
<table id="table_99BD3F007D164A2AA415E78C633D7927"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> <p>說AEM明 </p> </th> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Gems AEMon是Adobe專家提供的一系列技術深度潛水。 本系列補充了產品檔案與技術通道。 此外，它還可協助開發人員取得聯絡，並詳細探索特定主題。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_04819C0464594ECFB211C253C34E69CA"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> <p>AEM Hot fix版本 </p> </th> 
   <th colname="col2" class="entry"> <p>說明 </p> </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/tw/experience-manager/kb/aem62-available-hotfixes.html" format="https" scope="external"> AEM 6.2 Hotfix </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/tw/experience-manager/kb/aem61-available-hotfixes.html" format="https" scope="external"> AEM 6.1 Hotfix </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>新功能包括： 
     <ul id="ul_85C33A54E1B24FFDA1B948D5B337C2CA"> 
      <li id="li_128ED169444F4F11B221CBB19AD0B918"><p>規則運算式(regex)支援篩選器和快取規則。 </p></li> 
      <li id="li_2E996C54B8E24C01AC3C40F2E68308EA">在所有平台上支援HTTP持續連線（也稱為HTTP keep-alive）。 </li> 
...
下表包含一系列建議主題的連結。這些主題可協助您充份運用實作與使用AEM。
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>包AEM含經典和觸控最佳化的UI。 因此，「客戶專用的使用者介面Recommendations」主題可協助您決定最適合您使用的UI。 在專案實施期間或從舊版更新時，這些資訊會派上用場。 </p> </td> 
  </tr> 
  <tr> 
...
Advertising Cloud幫助可在&#x200B;**[!UICONTROL 產品中獲得？ > 說明內容]**。
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Experience Manager6.2是升級至Adobe Experience Manager6.1代碼庫的版本。它提供全新和增強的功能、關鍵客戶修正、高優先順序的客戶增強功能，以及針對產品穩定化的一般錯誤修正。 此外，還包含Adobe Experience Manager6.1功能套件、Hot Fix和Service Pack版本。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 有了適用於Analytics的Marketing Cloud對象整合，您就可以將Marketing Cloud對象資料(例如人口統計資訊（例如性別或收入等級）、心理變數資訊（例如興趣和嗜好）、CRM資料和廣告曝光資料整合至任何Analytics工作流程。 </p> </td> 
   <td colname="col3"> <p>2016 年 4 月 14 日 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>已新增有關Analysis Workspace新功能的檔案。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>更新Analysis Workspace產品檔案，其中包含功能說明、建立專案、影片和使用案例的工作。 </p> </td> 
   <td colname="col3"> <p>2015 年 9 月 17 日 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>請參閱Data Workbench6.5版本注意事項，以取得升級指示以及新功能和錯誤修正清單，包括新的關聯表格和弦圖，以及視覺化、使用者介面、演算法和匯出功能的更新。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>已將 <a href="https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-first-party.html" format="https" scope="external">Adobe Managed Certificate Program</a> 新增至翻新改造的<span class="term">第一方 Cookie</span> 產品文件。 </p> <p>受管理的憑證程式可讓您為第一方Cookie實作新的第一方SSL憑證，不需額外付費。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>改版AdobeMobile產品檔案。 </p> </td> 
   <td colname="col3"> <p>2015年5月22日 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>如果您在客戶關係管理(CRM)資料庫中擷取企業客戶資料，您可以將該資料上傳至Marketing Cloud。 </p> </td> 
   <td colname="col3"> <p>2015 年 3 月 19 日  </p> </td> 
  </tr> 
  <tr> 
