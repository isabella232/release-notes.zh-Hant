...
如需 [產品檔案，請參閱Adobe Mobile](https://marketing.adobe.com/resources/help/zh_TW/mobile/) Services。 若要參閱先前版本的發行說明，請展開左側面板的&#x200B;*先前發行說明*。

### 動態標籤管理 {#dtm}

| 功能 | 說明 |
|---|---|
| Marketing Cloud ID服務工具 | 現在預設會啟用讓DTM載入中的Marketing Cloud ID服務工具位於頁面頂端的選項。 |
...
另請參閱 [Marketing Cloud ID 服務](https://docs.adobe.com/content/help/zh-Hant/id-service/using/home.html)產品文件。
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>在 2016 年 10 月時，Analytics 管理員將能在 <span class="wintitle">Enterprise Dashboard</span> 中管理使用者和產品組態 (群組)。Enterprise Dashboard是Adobe的行銷、創意和檔案雲端管理介面。 </p> <p>您將能夠： </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_79999DF08A424BFDA59BDBCD2E738A4C"> 
      ...
      <li id="li_562AFA713CA34C009DC2FB0B4B8A26EF">管理員：修正無法追蹤使用Adobe ID透過Marketing Cloud登入之使用者之活動的問題。 此修正會複製傳統上透過公司名稱、使用者名稱和密碼登入的使用者的活動追蹤。 (AN-124792) </li> 
...
* 已變更舊版登入和Marketing Cloud之分隔線的樣式。 (AAM-24378)
  ...
  <tr> 
   ...
   <td colname="col2"> <p>新功能包括： 
     <ul id="ul_85C33A54E1B24FFDA1B948D5B337C2CA"> 
      ...
      <li id="li_2E996C54B8E24C01AC3C40F2E68308EA">在所有平台上支援HTTP永續連線（也稱為HTTP keep-alive）。 </li> 
...
下表包含一系列建議主題的連結。這些主題可協助您充份運用AEM的實作與使用。
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM包含經典和觸控最佳化的UI。 因此，「客戶適用的使用者介面建議」主題可協助您決定最適合您使用的UI。 在專案實施期間或從舊版更新時，這些資訊會派上用場。 </p> </td> 
  </tr> 
  <tr> 
