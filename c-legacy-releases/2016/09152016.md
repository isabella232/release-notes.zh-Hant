...
* 在 10 月 1 日後社交標記可用於 Adobe Analytics (確切日期未定)。
   * 在10月1日 [!DNL  Adobe Social] 之後，使用者將可以使用 [社交標籤](https://marketing.adobe.com/resources/help/en_US/social/c_settings_tag_manr.html) ，將傳出內容分類，並報告內的此內容 [!DNL  Adobe Analytics]。 若要取得這份清單以存取這項新功能，請聯絡您的 [!DNL  Adobe Social] 帳戶管理員或 Social 支援。您會在此收到有關取得存取權及啟用協助的後續步驟更新。
